...
var OpenSeaPort = /** @class */ (function () {
     ...
     */
    OpenSeaPort.prototype._getPriceParameters = function (tokenAddress, expirationTime, startAmount, endAmount, waitForBestCounterOrder) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        tokens = _a.sent();
                        token = tokens[0];
                        minimumExpirationTime = Date.now() / 1000;
                        // Validation
