...
var OpenSeaPort = /** @class */ (function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        transactionHash = "";
                        if (!(0, utils_1.isFeeWrapperFlow)(order, this._networkName)) return [3 /*break*/, 3];
                    ...
                    case 6:
                        if (useTxnOriginStaticCall) {
                            ...
                            return [2 /*return*/, {
                                    ...
                                    staticExtradata: (0, schema_1.encodeCall)((0, contracts_1.getMethod)(contracts_1.WyvernFeeWrapper, "expectInTransaction"), []),
                                }];
                        }
                        _c.label = 7;
                    case 7: return [2 /*return*/];
    ...
    OpenSeaPort.prototype._getBuyFeeParameters = function (totalBuyerFeeBasisPoints, totalSellerFeeBasisPoints, sellOrder) {
        ...
        return {
            ...
            feeRecipient: (0, utils_1.getFeeWrapperAddress)(this._networkName),
            feeMethod: types_1.FeeMethod.SplitFee,
        };
    };
    OpenSeaPort.prototype._getSellFeeParameters = function (totalBuyerFeeBasisPoints, totalSellerFeeBasisPoints, waitForHighestBid, sellerBountyBasisPoints) {
        ...
        var feeRecipient = waitForHighestBid
            ...
            : (0, utils_1.getFeeWrapperAddress)(this._networkName);
    ...
    OpenSeaPort.prototype._atomicMatch = function (_b) {
        var buy = _b.buy, sell = _b.sell, accountAddress = _b.accountAddress, _c = _b.metadata, metadata = _c === void 0 ? constants_1.NULL_BLOCK_HASH : _c, makerOrder = _b.makerOrder;
        return __awaiter(this, void 0, void 0, function () {
            var value, shouldValidateBuy, shouldValidateSell, txHash, txnData, args, useFeeWrapper, feeWrapperAddress, wyvernFeeWrapperArgs, wyvernFeeWrapperCalldata, response, feeDataWithEthersBigNum, wyvernArgsWithEthersBigNum, submitAtomicMatchTransaction, error_13;
            var _this = this;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                    ...
                    case 7:
                        ...
                        useFeeWrapper = (0, utils_1.isFeeWrapperFlow)(buy, this._networkName) ||
                            (0, utils_1.isFeeWrapperFlow)(sell, this._networkName);
                        feeWrapperAddress = (0, utils_1.getFeeWrapperAddress)(this._networkName);
                    ...
                    case 9:
                            ...
                            return __generator(this, function (_c) {
                                switch (_c.label) {
                                    case 0:
                                        ...
                                        _b = (0, utils_1.sendRawTransaction)(this.web3, {
                                            from: accountAddress,
                        ...
                        try {
                            ...
                            throw new Error("Oops, the Ethereum network rejected this transaction :( The OpenSea devs have been alerted, but this problem is typically due an item being locked or untransferrable. The exact error was \"".concat(error instanceof Error
                    ...
                    case 12:
                        ...
                        throw new Error("Failed to authorize transaction: \"".concat(error_13 instanceof Error ? error_13.message : "user denied", "...\""));
