            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        txHash = _b.sent();
                        transactionHash = txHash.toString();
                        this._dispatch(types_1.EventType.ApproveCurrency, { accountAddress: accountAddress, tokenAddress: tokenAddress, transactionHash: transactionHash });
                        return [4 /*yield*/, wyvern_1.confirmTransaction(this.web3, transactionHash)];
                    case 2:
                        _b.sent();
                        this._dispatch(types_1.EventType.ApproveCurrencyComplete, { accountAddress: accountAddress, tokenAddress: tokenAddress });
                        return [2 /*return*/];
                }
            });
        });
