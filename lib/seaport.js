...
var OpenSeaPort = /** @class */ (function () {
    ...
    OpenSeaPort.prototype.computeFees = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var asset, totalBuyerFeeBPS, totalSellerFeeBPS, openseaBuyerFeeBPS, openseaSellerFeeBPS, devBuyerFeeBPS, devSellerFeeBPS, transferFee, transferFeeTokenAddress, maxTotalBountyBPS, _d, tokenAddress, tokenId, sellerBountyBPS, bountyTooLarge, errorMessage;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 2:
                        ...
                        if (side == types_1.OrderSide.Sell && asset && asset.transferFee && asset.transferFeePaymentToken) {
                            // TODO web3 call to update it
                            transferFee = utils_1.makeBigNumber(asset.transferFee);
