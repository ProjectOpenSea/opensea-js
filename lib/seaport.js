...
var OpenSeaPort = /** @class */ (function () {
    ...
    OpenSeaPort.prototype.computeFees = function (_a) {
        var assets = _a.assets, assetContract = _a.assetContract, side = _a.side, _b = _a.isPrivate, isPrivate = _b === void 0 ? false : _b, _c = _a.bountyBasisPoints, bountyBasisPoints = _c === void 0 ? 0 : _c;
        return __awaiter(this, void 0, void 0, function () {
            var contractFees, _d, tokenAddress, tokenId, asset, totalBuyerFeeBPS, totalSellerFeeBPS, openseaBuyerFeeBPS, openseaSellerFeeBPS, devBuyerFeeBPS, devSellerFeeBPS, sellerBountyBPS, buyerBountyBPS;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        if (!assetContract) return [3 /*break*/, 1];
                    ...
                    case 3:
                        ...
                        _e.label = 4;
                    case 4:
                        totalBuyerFeeBPS = contractFees.buyerFeeBasisPoints || utils_1.DEFAULT_BUYER_FEE_BASIS_POINTS;
                        totalSellerFeeBPS = contractFees.sellerFeeBasisPoints || utils_1.DEFAULT_SELLER_FEE_BASIS_POINTS;
                        openseaBuyerFeeBPS = contractFees.openseaBuyerFeeBasisPoints || totalBuyerFeeBPS;
                        openseaSellerFeeBPS = contractFees.openseaSellerFeeBasisPoints || totalSellerFeeBPS;
                        devBuyerFeeBPS = contractFees.devBuyerFeeBasisPoints || 0;
                        devSellerFeeBPS = contractFees.devSellerFeeBasisPoints || 0;
