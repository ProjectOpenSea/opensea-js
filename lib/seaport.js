...
var OpenSeaPort = /** @class */ (function () {
    ...
    OpenSeaPort.prototype.isAssetTransferrable = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var tokenContract, erc721, data, gas, error_7;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        tokenContract = this.web3.eth.contract(tokenAbi);
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 14:
                        ...
                        throw new Error("Oops, the Ethereum network rejected this transaction :( The OpenSea devs have been alerted, but this problem is typically due to one or more items being locked or untransferrable. The exact error was \"" + error_8.message.substr(0, MAX_ERROR_LENGTH) + "...\"");
                    case 15:
