...
var OpenSeaPort = /** @class */ (function () {
    ...
    OpenSeaPort.prototype.approveNonFungibleToken = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var tokenContract, erc721, isApprovedCheckData, isApprovedForAllCallHash, isApprovedForAll, gasPrice, txHash, error_6, approvedAddr, gasPrice, txHash, error_7;
            var _this = this;
                        ...
                        return [2 /*return*/, Promise.all(wyAssets.map(function (wyAsset) { return __awaiter(_this, void 0, void 0, function () {
                                ...
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        ...
                                        case 1:
                                            where = _a.sent();
                                            if (where != types_1.WyvernAssetLocation.Account) {
