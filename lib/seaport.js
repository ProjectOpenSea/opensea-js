...
var OpenSeaPort = /** @class */ (function () {
    ...
    OpenSeaPort.prototype.transferOne = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var schema, wyAsset, openseaAsset, abi, recipient, gasPrice, txHash;
            var _this = this;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        abi = utils_1.getTransferFunction(schema)(wyAsset);
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    case 0:
                        ...
                        schema = this._getSchema();
                        wyAsset = utils_1.getWyvernNFTAsset(schema, asset.tokenId, asset.tokenAddress);
                                    ...
                                    switch (_a.label) {
                                        ...
                                        case 1:
                                            ...
                                            switch (schema.name) {
                                                ...
                                                case types_1.WyvernSchemaName.ENSName:
                                                    // TODO: non-NFTs
