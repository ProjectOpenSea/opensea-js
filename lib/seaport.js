...
var OpenSeaPort = /** @class */ (function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this._atomicMatch({ buy: buy, sell: sell, accountAddress: accountAddress, metadata: metadata }, false)];
                    case 1:
    ...
    OpenSeaPort.prototype.getFulfillOrderGasEstimation = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                ...
                _b = utils_1.assignOrdersToSides(order, matchingOrder), buy = _b.buy, sell = _b.sell;
                metadata = this._getMetadata(order, referrerAddress);
                return [2 /*return*/, this._atomicMatch({ buy: buy, sell: sell, accountAddress: accountAddress, metadata: metadata }, true)];
            });
        });
    };
    /**
    ...
    OpenSeaPort.prototype._atomicMatch = function (_a, onlyGetGasEstimation) {
        var buy = _a.buy, sell = _a.sell, accountAddress = _a.accountAddress, _b = _a.metadata, metadata = _b === void 0 ? constants_1.NULL_BLOCK_HASH : _b;
        return __awaiter(this, void 0, void 0, function () {
