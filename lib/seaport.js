...
var OpenSeaPort = /** @class */ (function () {
    ...
    OpenSeaPort.prototype._makeSellOrder = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var schema, quantityBN, wyAsset, isPrivate, openSeaAsset, _b, totalSellerFeeBasisPoints, totalBuyerFeeBasisPoints, sellerBountyBPS, _c, target, calldata, replacementPattern, orderSaleKind, _d, basePrice, extra, paymentToken, times, _e, makerRelayerFee, takerRelayerFee, makerProtocolFee, takerProtocolFee, makerReferrerFee, feeRecipient, feeMethod, _f, staticTarget, staticExtradata;
            return __generator(this, function (_g) {
                switch (_g.label) {
                    case 0:
                        accountAddress = utils_1.validateAndFormatWalletAddress(this.web3ReadOnly, accountAddress);
    ...
    OpenSeaPort.prototype._makeBundleBuyOrder = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var quantityBNs, schemas, bundle, taker, _d, totalBuyerFeeBasisPoints, totalSellerFeeBasisPoints, _e, makerRelayerFee, takerRelayerFee, makerProtocolFee, takerProtocolFee, makerReferrerFee, feeRecipient, feeMethod, _f, calldata, replacementPattern, _g, basePrice, extra, paymentToken, times;
            var _this = this;
                ...
                switch (_h.label) {
                    case 0:
                        ...
                        taker = sellOrder
                            ? sellOrder.maker
                            : constants_1.NULL_ADDRESS;
                        return [4 /*yield*/, this.computeFees({ fees: collection, extraBountyBasisPoints: extraBountyBasisPoints, side: types_1.OrderSide.Buy })];
                    case 1:
    ...
    OpenSeaPort.prototype._getSellFeeParameters = function (totalBuyerFeeBasisPoints, totalSellerFeeBasisPoints, waitForHighestBid, sellerBountyBPS) {
