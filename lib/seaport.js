...
var OpenSeaPort = /** @class */ (function () {
    ...
    OpenSeaPort.prototype._atomicMatch = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var value, shouldValidateBuy, shouldValidateSell, txHash, txnData, args, useFeeWrapper, feeWrapperAddress, wyvernFeeWrapperArgs, wyvernFeeWrapperCalldata, response, feeDataAsBigNum, wyvernArgsWithBigNum, atomicMatchEstimateGas, submitAtomicMatchTransaction, gasEstimate, error_13, error_14;
            var _this = this;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                    ...
                    case 8:
                        response = _c.sent();
                        feeDataAsBigNum = response.fulfillment_data.fee_data.map(function (_a) {
                            var recipient = _a[0], amount = _a[1];
                            return [recipient, ethers_1.ethers.BigNumber.from(amount)];
                        });
                        wyvernArgsWithBigNum = __spreadArray(__spreadArray(__spreadArray([], args.slice(0, 1)), [args[1].map(ethers_1.ethers.BigNumber.from)]), args.slice(2));
                        debugger;
