...
var OpenSeaPort = /** @class */ (function () {
    ...
    OpenSeaPort.prototype._atomicMatch = function (_a) {
        var buy = _a.buy, sell = _a.sell, accountAddress = _a.accountAddress;
        return __awaiter(this, void 0, void 0, function () {
            var value, orderLookupHash, buyValid, sellValid, txHash, gasPrice, txnData, args, gasEstimate, error_7, error_8;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                    ...
                    case 14:
                        ...
                        throw new Error("Oops, the Ethereum network rejected this transaction :( OpenSea has been alerted, but this problem typically goes away if you try again later. The exact error was \"" + error_7.message.substr(0, MAX_ERROR_LENGTH) + "...\"");
                    case 15:
                    ...
                    case 17:
                        ...
                        throw new Error("Failed to authorize transaction: \"" + (error_8.message
                            ? error_8.message
                            : 'user denied') + "...\"");
    ...
    OpenSeaPort.prototype._confirmTransaction = function (transactionHash, event, description) {
        return __awaiter(this, void 0, void 0, function () {
            var transactionEventData, error_9;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 3:
                        ...
                        this._dispatch(types_1.EventType.TransactionFailed, __assign({}, transactionEventData, { error: error_9 }));
                        throw error_9;
                    case 4: return [2 /*return*/];
                }
            });
