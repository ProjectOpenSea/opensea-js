...
var OpenSeaPort = /** @class */ (function () {
    ...
    function OpenSeaPort(provider, apiConfig, logger) {
        ...
        apiConfig.gasPrice = apiConfig.gasPrice || utils_1.makeBigNumber(100000);
        // API config
    ...
    OpenSeaPort.prototype._initializeProxy = function (accountAddress) {
        return __awaiter(this, void 0, void 0, function () {
            var gasPrice, transactionHash, proxyAddress;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        gasPrice = _a.sent();
                        return [4 /*yield*/, this._wyvernProtocol.wyvernProxyRegistry.registerProxy.sendTransactionAsync({
                                from: accountAddress,
                                gasPrice: gasPrice
                            })];
                    case 2:
    ...
    OpenSeaPort.prototype._makeBundleSellOrder = function (_a) {
        ...
        var transactions = wyAssets.map(function (wyAsset) {
            var _a = WyvernSchemas.encodeSell(schema, wyAsset, accountAddress), target = _a.target, calldata = _a.calldata;
            return {
                calldata: calldata,
                address: target,
                value: utils_1.makeBigNumber(0)
            };
        });
        var atomicizedCalldata = this._wyvernProtocol.wyvernAtomicizer.atomicize.getABIEncodedTransactionData(transactions.map(function (t) { return t.address; }), transactions.map(function (t) { return t.value; }), transactions.map(function (t) { return utils_1.makeBigNumber((t.calldata.length - 2) / 2); }), // subtract 2 for '0x', divide by 2 for hex
    ...
    OpenSeaPort.prototype._atomicMatch = function (_a) {
        var buy = _a.buy, sell = _a.sell, accountAddress = _a.accountAddress;
        return __awaiter(this, void 0, void 0, function () {
            var value, orderLookupHash, buyValid, sellValid, txHash, gasPrice, error_6;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                    ...
                    case 14:
                        ...
                        throw new Error("Failed to authorize transaction: \"" + (error_6.message
                            ? error_6.message
                            : 'user denied') + "...\"");
