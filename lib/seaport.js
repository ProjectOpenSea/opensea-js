...
import { CHEEZE_WIZARDS_BASIC_TOURNAMENT_ADDRESS, CHEEZE_WIZARDS_BASIC_TOURNAMENT_RINKEBY_ADDRESS, CHEEZE_WIZARDS_GUILD_ADDRESS, CHEEZE_WIZARDS_GUILD_RINKEBY_ADDRESS, CK_ADDRESS, CK_RINKEBY_ADDRESS, DECENTRALAND_ESTATE_ADDRESS, DEFAULT_BUYER_FEE_BASIS_POINTS, DEFAULT_GAS_INCREASE_FACTOR, DEFAULT_MAX_BOUNTY, DEFAULT_SELLER_FEE_BASIS_POINTS, DEFAULT_WRAPPED_NFT_LIQUIDATION_UNISWAP_SLIPPAGE_IN_BASIS_POINTS, ENJIN_COIN_ADDRESS, INVERSE_BASIS_POINT, MANA_ADDRESS, MIN_EXPIRATION_SECONDS, NULL_ADDRESS, NULL_BLOCK_HASH, OPENSEA_SELLER_BOUNTY_BASIS_POINTS, ORDER_MATCHING_LATENCY_SECONDS, RPC_URL_PATH, SELL_ORDER_BATCH_SIZE, STATIC_CALL_CHEEZE_WIZARDS_ADDRESS, STATIC_CALL_CHEEZE_WIZARDS_RINKEBY_ADDRESS, STATIC_CALL_DECENTRALAND_ESTATES_ADDRESS, STATIC_CALL_TX_ORIGIN_ADDRESS, STATIC_CALL_TX_ORIGIN_RINKEBY_ADDRESS, UNISWAP_FACTORY_ADDRESS_MAINNET, UNISWAP_FACTORY_ADDRESS_RINKEBY, WRAPPED_NFT_FACTORY_ADDRESS_MAINNET, WRAPPED_NFT_FACTORY_ADDRESS_RINKEBY, WRAPPED_NFT_LIQUIDATION_PROXY_ADDRESS_MAINNET, WRAPPED_NFT_LIQUIDATION_PROXY_ADDRESS_RINKEBY, FEE_WRAPPER_ADDRESS_MAINNET, FEE_WRAPPER_ADDRESS_RINKEBY, OPENSEA_FEE_RECIPIENT, } from "./constants";
...
import { EventType, FeeMethod, HowToCall, Network, OrderSide, SaleKind, TokenStandardVersion, WyvernSchemaName, } from "./types";
import { encodeAtomicizedBuy, encodeAtomicizedSell, encodeAtomicizedTransfer, encodeBuy, encodeCall, encodeProxyCall, encodeSell, encodeTransferCall, } from "./utils/schema";
import { annotateERC20TransferABI, annotateERC721TransferABI, assignOrdersToSides, confirmTransaction, delay, estimateCurrentPrice, estimateGas, getCurrentGasPrice, getNonCompliantApprovalAddress, getOrderHash, getTransferFeeSettings, getWyvernAsset, getWyvernBundle, isContractAddress, makeBigNumber, onDeprecated, orderToJSON, personalSignAsync, promisifyCall, rawCall, sendRawTransaction, validateAndFormatWalletAddress, isFeeWrapperFlow, getFeeWrapperAddress, } from "./utils/utils";
var OpenSeaPort = /** @class */ (function () {
    ...
    function OpenSeaPort(provider, apiConfig, logger) {
        ...
        this.gasPriceAddition = new BigNumber(3);
        // Multiply gas estimate by this factor when making transactions
        this.gasIncreaseFactor = DEFAULT_GAS_INCREASE_FACTOR;
        // API config
        apiConfig.networkName = apiConfig.networkName || Network.Main;
        this.api = new OpenSeaAPI(apiConfig);
        this._networkName = apiConfig.networkName;
        var readonlyProvider = new Web3.providers.HttpProvider("".concat(this.api.apiBaseUrl, "/").concat(RPC_URL_PATH));
    ...
    OpenSeaPort.prototype.wrapAssets = function (_b) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        schema = this._getSchema(WyvernSchemaName.ERC721);
                        wyAssets = assets.map(function (a) { return getWyvernAsset(schema, a); });
                        ...
                        this._dispatch(EventType.WrapAssets, { assets: wyAssets, accountAddress: accountAddress });
                        return [4 /*yield*/, sendRawTransaction(this.web3, {
                                from: accountAddress,
                                ...
                                _this._dispatch(EventType.TransactionDenied, { error: error, accountAddress: accountAddress });
                            })];
                    case 1:
                        txHash = _c.sent();
                        return [4 /*yield*/, this._confirmTransaction(txHash, EventType.WrapAssets, "Wrapping Assets")];
                    case 2:
                        _c.sent();
                        return [2 /*return*/];
                }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        txHash = _c.sent();
                        return [4 /*yield*/, this._confirmTransaction(txHash, EventType.UnwrapAssets, "Unwrapping Assets")];
                    case 2:
                        _c.sent();
                        return [2 /*return*/];
                }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        txHash = _c.sent();
                        return [4 /*yield*/, this._confirmTransaction(txHash, EventType.LiquidateAssets, "Liquidating Assets")];
                    case 2:
                        _c.sent();
                        return [2 /*return*/];
                }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        txHash = _c.sent();
                        return [4 /*yield*/, this._confirmTransaction(txHash, EventType.PurchaseAssets, "Purchasing Assets")];
                    case 2:
                        _c.sent();
                        return [2 /*return*/];
                }
    ...
    OpenSeaPort.prototype.getQuoteFromUniswap = function (_b) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        wrappedNFTFactoryContract = this.web3.eth.contract(WrappedNFTFactory);
                    ...
                    case 2:
                        ...
                        wrappedNFTContract = this.web3.eth.contract(WrappedNFT);
                        return [4 /*yield*/, wrappedNFTContract.at(wrappedNFTAddress)];
                    case 3:
                        wrappedNFT = _e.sent();
                        uniswapFactoryContract = this.web3.eth.contract(UniswapFactory);
                    ...
                    case 5:
                        ...
                        uniswapExchangeContract = this.web3.eth.contract(UniswapExchange);
                        return [4 /*yield*/, uniswapExchangeContract.at(uniswapExchangeAddress)];
                    case 6:
                        uniswapExchange = _e.sent();
                        amount = WyvernProtocol.toBaseUnitAmount(makeBigNumber(numTokens), wrappedNFT.decimals());
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        amount = WyvernProtocol.toBaseUnitAmount(makeBigNumber(amountInEth), token.decimals);
                        this._dispatch(EventType.WrapEth, { accountAddress: accountAddress, amount: amount });
                        return [4 /*yield*/, sendRawTransaction(this.web3, {
                                from: accountAddress,
                                to: token.address,
                                value: amount,
                    ...
                    case 1:
                        txHash = _c.sent();
                        return [4 /*yield*/, this._confirmTransaction(txHash, EventType.WrapEth, "Wrapping ETH")];
                    case 2:
                        _c.sent();
                        return [2 /*return*/];
                }
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        token = WyvernSchemas.tokens[this._networkName].canonicalWrappedEther;
                        amount = WyvernProtocol.toBaseUnitAmount(makeBigNumber(amountInEth), token.decimals);
                        this._dispatch(EventType.UnwrapWeth, { accountAddress: accountAddress, amount: amount });
                        return [4 /*yield*/, sendRawTransaction(this.web3, {
                                from: accountAddress,
                                to: token.address,
                                value: 0,
                    ...
                    case 1:
                        txHash = _c.sent();
                        return [4 /*yield*/, this._confirmTransaction(txHash, EventType.UnwrapWeth, "Unwrapping W-ETH")];
                    case 2:
                        _c.sent();
                        return [2 /*return*/];
                }
            ...
            return __generator(this, function (_j) {
                switch (_j.label) {
                    ...
                    case 2:
                        ...
                        batches = _.chunk(range, SELL_ORDER_BATCH_SIZE);
                        numOrdersCreated = 0;
    ...
    OpenSeaPort.prototype.fulfillOrder = function (_b) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var matchingOrder, _c, buy, sell, metadata, transactionHash, vrs, properlySignedMatchingOrder;
            var _this = this;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        _c = assignOrdersToSides(order, matchingOrder), buy = _c.buy, sell = _c.sell;
                        metadata = this._getMetadata(order, referrerAddress);
                        transactionHash = "";
                        if (!isFeeWrapperFlow(order, this._networkName)) return [3 /*break*/, 3];
                        return [4 /*yield*/, this._authorizeOrder(matchingOrder, true)];
                    case 1:
                        vrs = _d.sent();
                        properlySignedMatchingOrder = __assign(__assign({}, matchingOrder), vrs);
                        return [4 /*yield*/, this._atomicMatch({
                                buy: properlySignedMatchingOrder.side === OrderSide.Buy
                                    ? properlySignedMatchingOrder
                                    : buy,
                                sell: properlySignedMatchingOrder.side === OrderSide.Sell
                                    ? properlySignedMatchingOrder
                                    : sell,
                                accountAddress: accountAddress,
                                metadata: metadata,
                    ...
                    case 2:
                        ...
                        return [3 /*break*/, 5];
                    case 3: return [4 /*yield*/, this._atomicMatch({
                            buy: buy,
                            sell: sell,
                            accountAddress: accountAddress,
                            metadata: metadata,
                    ...
                    case 4:
                        transactionHash = _d.sent();
                        _d.label = 5;
                    case 5: return [4 /*yield*/, this._confirmTransaction(transactionHash, EventType.MatchOrders, "Fulfilling order", function () { return __awaiter(_this, void 0, void 0, function () {
                            var isOpen;
                            return __generator(this, function (_b) {
                                switch (_b.label) {
    ...
    OpenSeaPort.prototype.cancelOrder = function (_b) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        this._dispatch(EventType.CancelOrder, { order: order, accountAddress: accountAddress });
                        return [4 /*yield*/, this._wyvernProtocol.wyvernExchange.cancelOrder_.sendTransactionAsync([
                                ...
                                order.salt,
                            ], order.feeMethod, order.side, order.saleKind, order.howToCall, order.calldata, order.replacementPattern, order.staticExtradata, order.v || 0, order.r || NULL_BLOCK_HASH, order.s || NULL_BLOCK_HASH, { from: accountAddress })];
                    case 1:
                        transactionHash = _c.sent();
                        return [4 /*yield*/, this._confirmTransaction(transactionHash.toString(), EventType.CancelOrder, "Cancelling order", function () { return __awaiter(_this, void 0, void 0, function () {
                                var isOpen;
                                return __generator(this, function (_b) {
                                    switch (_b.label) {
                                        case 0: return [4 /*yield*/, this._validateOrder(order)];
    ...
    OpenSeaPort.prototype.approveSemiOrNonFungibleToken = function (_b) {
        var tokenId = _b.tokenId, tokenAddress = _b.tokenAddress, accountAddress = _b.accountAddress, proxyAddress = _b.proxyAddress, _c = _b.tokenAbi, tokenAbi = _c === void 0 ? ERC721 : _c, _d = _b.skipApproveAllIfTokenAddressIn, skipApproveAllIfTokenAddressIn = _d === void 0 ? new Set() : _d, _e = _b.schemaName, schemaName = _e === void 0 ? WyvernSchemaName.ERC721 : _e;
        return __awaiter(this, void 0, void 0, function () {
                ...
                switch (_f.label) {
                    ...
                    case 3:
                        approvalAllCheck = function () { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    case 0: return [4 /*yield*/, rawCall(this.web3ReadOnly, {
                                            from: accountAddress,
                                            to: contract.address,
                    ...
                    case 5:
                        ...
                        return [4 /*yield*/, sendRawTransaction(this.web3, {
                                ...
                                _this._dispatch(EventType.TransactionDenied, {
                                    error: error,
                                    accountAddress: accountAddress,
                                });
                            })];
                    case 6:
                        txHash = _f.sent();
                        return [4 /*yield*/, this._confirmTransaction(txHash, EventType.ApproveAllAssets, "Approving all tokens of this type for trading", function () { return __awaiter(_this, void 0, void 0, function () {
                                var result;
                                return __generator(this, function (_b) {
                                    switch (_b.label) {
                    ...
                    case 9:
                        ...
                        approvalOneCheck = function () { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    case 0: return [4 /*yield*/, promisifyCall(function (c) {
                                    ...
                                    case 1:
                                        ...
                                        return [4 /*yield*/, getNonCompliantApprovalAddress(contract, tokenId, accountAddress)];
                                    case 2:
                                        approvedAddr = _b.sent();
                                        if (approvedAddr == proxyAddress) {
                    ...
                    case 11:
                        ...
                        this._dispatch(EventType.ApproveAsset, {
                            accountAddress: accountAddress,
                            proxyAddress: proxyAddress,
                            asset: getWyvernAsset(schema, { tokenId: tokenId, tokenAddress: tokenAddress }),
                        });
                        return [4 /*yield*/, sendRawTransaction(this.web3, {
                                from: accountAddress,
                                to: contract.address,
                    ...
                    case 12:
                        txHash = _f.sent();
                        return [4 /*yield*/, this._confirmTransaction(txHash, EventType.ApproveAsset, "Approving single token for trading", approvalOneCheck)];
                    case 13:
                        _f.sent();
                        return [2 /*return*/, txHash];
                    case 14:
    ...
    OpenSeaPort.prototype.approveFungibleToken = function (_b) {
        var accountAddress = _b.accountAddress, tokenAddress = _b.tokenAddress, proxyAddress = _b.proxyAddress, _c = _b.minimumAmount, minimumAmount = _c === void 0 ? WyvernProtocol.MAX_UINT_256 : _c;
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 1:
                        ...
                        hasOldApproveMethod = [ENJIN_COIN_ADDRESS, MANA_ADDRESS].includes(tokenAddress.toLowerCase());
                    ...
                    case 2:
                        ...
                        _d.sent();
                        _d.label = 3;
                    case 3: return [4 /*yield*/, sendRawTransaction(this.web3, {
                            from: accountAddress,
                            to: tokenAddress,
                    ...
                    case 4:
                        txHash = _d.sent();
                        return [4 /*yield*/, this._confirmTransaction(txHash, EventType.ApproveCurrency, "Approving currency for trading", function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        txHash = _c.sent();
                        return [4 /*yield*/, this._confirmTransaction(txHash, EventType.UnapproveCurrency, "Resetting Currency Approval", function () { return __awaiter(_this, void 0, void 0, function () {
                                var newlyApprovedAmount;
                                return __generator(this, function (_b) {
                                    switch (_b.label) {
                                        case 0: return [4 /*yield*/, this._getApprovedTokenCount({
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 1:
                        gas = _d.sent();
                        this.logger("Gas estimate for ".concat(order.side == OrderSide.Sell ? "sell" : "buy", " order: ").concat(gas));
                ...
                switch (_d.label) {
                    case 0:
                        ...
                        quantityBN = quantity
                            ...
                            : makeBigNumber(1);
                        wyAsset = getWyvernAsset(schema, asset, quantityBN);
                    ...
                    case 3:
                        _d.trys.push([3, 5, , 8]);
                        return [4 /*yield*/, estimateGas(this._getClientsForRead(retries).web3, {
                                from: from,
                                to: abi.target,
                                data: data,
                            })];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        schema = this._getSchema(asset.schemaName);
                        quantityBN = WyvernProtocol.toBaseUnitAmount(makeBigNumber(quantity), asset.decimals || 0);
                        wyAsset = getWyvernAsset(schema, asset, quantityBN);
                        isCryptoKitties = [CK_ADDRESS, CK_RINKEBY_ADDRESS].includes(wyAsset.address);
                        isOldNFT = isCryptoKitties ||
                            (!!asset.version &&
                                [TokenStandardVersion.ERC721v1, TokenStandardVersion.ERC721v2].includes(asset.version));
                        abi = asset.schemaName === WyvernSchemaName.ERC20
                            ? annotateERC20TransferABI(wyAsset)
                            : isOldNFT
                    ...
                    case 1:
                        txHash = _d.sent();
                        return [4 /*yield*/, this._confirmTransaction(txHash, EventType.TransferOne, "Transferring asset")];
                    case 2:
                        _d.sent();
                        return [2 /*return*/, txHash];
                }
    ...
    OpenSeaPort.prototype.transferAll = function (_b) {
        var assets = _b.assets, fromAddress = _b.fromAddress, toAddress = _b.toAddress, _c = _b.schemaName, schemaName = _c === void 0 ? WyvernSchemaName.ERC721 : _c;
        return __awaiter(this, void 0, void 0, function () {
                ...
                switch (_e.label) {
                    case 0:
                        ...
                        wyAssets = assets.map(function (asset) {
                            return getWyvernAsset(_this._getSchema(asset.schemaName), asset);
                        });
                        _d = encodeAtomicizedTransfer(schemaNames.map(function (name) { return _this._getSchema(name); }), wyAssets, fromAddress, toAddress, this._wyvernProtocol, this._networkName), calldata = _d.calldata, target = _d.target;
                        return [4 /*yield*/, this._getProxy(fromAddress)];
                    case 1:
                    ...
                    case 5:
                        txHash = _e.sent();
                        return [4 /*yield*/, this._confirmTransaction(txHash, EventType.TransferAll, "Transferring ".concat(assets.length, " asset").concat(assets.length == 1 ? "" : "s"))];
                    case 6:
                        _e.sent();
                        return [2 /*return*/, txHash];
                }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        schema = this._getSchema(asset.schemaName);
                        wyAsset = getWyvernAsset(schema, asset);
    ...
    OpenSeaPort.prototype.getTokenBalance = function (_b, retries) {
        var accountAddress = _b.accountAddress, tokenAddress = _b.tokenAddress, _c = _b.schemaName, schemaName = _c === void 0 ? WyvernSchemaName.ERC20 : _c;
        if (retries === void 0) { retries = 1; }
        return __awaiter(this, void 0, void 0, function () {
            var asset;
            return __generator(this, function (_d) {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        transferFee = makeBigNumber(0);
                        transferFeeTokenAddress = null;
                        maxTotalBountyBPS = DEFAULT_MAX_BOUNTY;
                        if (asset) {
                        ...
                        if (!(side == OrderSide.Sell && asset)) return [3 /*break*/, 4];
                    ...
                    case 1:
                        _d.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, getTransferFeeSettings(this.web3, {
                                asset: asset,
                                accountAddress: accountAddress,
                            })];
                    case 2:
                    ...
                    case 3:
                        ...
                        return [3 /*break*/, 4];
                    case 4:
                        sellerBountyBasisPoints = side == OrderSide.Sell ? extraBountyBasisPoints : 0;
                        bountyTooLarge = sellerBountyBasisPoints + OPENSEA_SELLER_BOUNTY_BASIS_POINTS >
                            maxTotalBountyBPS;
                        if (sellerBountyBasisPoints > 0 && bountyTooLarge) {
                            ...
                            if (maxTotalBountyBPS >= OPENSEA_SELLER_BOUNTY_BASIS_POINTS) {
                                errorMessage += " Remember that OpenSea will add ".concat(OPENSEA_SELLER_BOUNTY_BASIS_POINTS / 100, "% for referrers with OpenSea accounts!");
                            }
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.api.postOrder(orderToJSON(order))];
                    case 2:
    ...
    OpenSeaPort.prototype._computeGasPrice = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, getCurrentGasPrice(this.web3)];
                    case 1:
                        meanGas = _b.sent();
    ...
    OpenSeaPort.prototype._estimateGasForMatch = function (_b, retries) {
        var buy = _b.buy, sell = _b.sell, accountAddress = _b.accountAddress, _c = _b.metadata, metadata = _c === void 0 ? NULL_BLOCK_HASH : _c;
        if (retries === void 0) { retries = 1; }
        return __awaiter(this, void 0, void 0, function () {
            var value, error_10;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        if (!(buy.maker.toLowerCase() == accountAddress.toLowerCase() &&
                            buy.paymentToken == NULL_ADDRESS)) return [3 /*break*/, 2];
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 2:
                        _e.sent();
                        _d = encodeAtomicizedTransfer(schemaNames.map(function (name) { return _this._getSchema(name); }), wyAssets, fromAddress, toAddress, this._wyvernProtocol, this._networkName), calldata = _d.calldata, target = _d.target;
                        return [2 /*return*/, estimateGas(this.web3, {
                                from: fromAddress,
                                to: proxyAddress,
                                data: encodeProxyCall(target, HowToCall.DelegateCall, calldata),
                            })];
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        if (!(!proxyAddress || proxyAddress == NULL_ADDRESS)) return [3 /*break*/, 5];
    ...
    OpenSeaPort.prototype._initializeProxy = function (accountAddress) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        this._dispatch(EventType.InitializeAccount, { accountAddress: accountAddress });
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this._confirmTransaction(transactionHash, EventType.InitializeAccount, "Initializing proxy for account", function () { return __awaiter(_this, void 0, void 0, function () {
                                var polledProxy;
                                return __generator(this, function (_b) {
                                    switch (_b.label) {
                ...
                switch (_c.label) {
                    case 0:
                        ...
                        addressToApprove = proxyAddress ||
                            WyvernProtocol.getTokenTransferProxyAddress(this._networkName);
                        return [4 /*yield*/, rawCall(this.web3, {
                                from: accountAddress,
                                to: tokenAddress,
                    ...
                    case 1:
                        approved = _c.sent();
                        return [2 /*return*/, makeBigNumber(approved)];
                }
            });
        });
    };
            ...
            return __generator(this, function (_k) {
                switch (_k.label) {
                    ...
                    case 1:
                        ...
                        taker = sellOrder ? sellOrder.maker : NULL_ADDRESS;
                    ...
                    case 2:
                        ...
                        _g = encodeBuy(schema, wyAsset, accountAddress), target = _g.target, calldata = _g.calldata, replacementPattern = _g.replacementPattern;
                        return [4 /*yield*/, this._getPriceParameters(OrderSide.Buy, paymentTokenAddress, expirationTime, startAmount)];
                    case 3:
            ...
            return __generator(this, function (_j) {
                switch (_j.label) {
                    ...
                    case 2:
                        ...
                        _e = encodeSell(schema, wyAsset, accountAddress), target = _e.target, calldata = _e.calldata, replacementPattern = _e.replacementPattern;
                        orderSaleKind = endAmount != null && endAmount !== startAmount
                            ? SaleKind.DutchAuction
                            : SaleKind.FixedPrice;
                        return [4 /*yield*/, this._getPriceParameters(OrderSide.Sell, paymentTokenAddress, expirationTime, startAmount, endAmount, waitForHighestBid, englishAuctionReservePrice)];
                    case 3:
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        isMainnet = this._networkName == Network.Main;
                        ...
                        cheezeWizardsBasicTournamentABI = this.web3.eth.contract(CheezeWizardsBasicTournament);
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, {
                                staticTarget: isMainnet
                                    ...
                                    : STATIC_CALL_CHEEZE_WIZARDS_RINKEBY_ADDRESS,
                                staticExtradata: encodeCall(getMethod(StaticCheckCheezeWizards, "succeedIfCurrentWizardFingerprintMatchesProvidedWizardFingerprint"), [asset.tokenId, wizardFingerprint, useTxnOriginStaticCall]),
                            }];
                    case 3:
                        if (!(isDecentralandEstate && isMainnet)) return [3 /*break*/, 6];
                        decentralandEstateAddress = DECENTRALAND_ESTATE_ADDRESS;
                        decentralandEstateABI = this.web3.eth.contract(DecentralandEstates);
                    ...
                    case 5:
                        ...
                        return [2 /*return*/, {
                                ...
                                staticExtradata: encodeCall(getMethod(StaticCheckDecentralandEstates, "succeedIfCurrentEstateFingerprintMatchesProvidedEstateFingerprint"), [asset.tokenId, estateFingerprint, useTxnOriginStaticCall]),
                            }];
                    case 6:
                        if (useTxnOriginStaticCall) {
                            ...
                            return [2 /*return*/, {
                                    staticTarget: this._networkName === Network.Main
                ...
                switch (_k.label) {
                    case 0:
                        ...
                        quantityBNs = quantities.map(function (quantity, i) {
                            return WyvernProtocol.toBaseUnitAmount(makeBigNumber(quantity), assets[i].decimals || 0);
                        });
                        bundle = getWyvernBundle(assets, assets.map(function (a) { return _this._getSchema(a.schemaName); }), quantityBNs);
                    ...
                    case 4:
                        ...
                        _h = encodeAtomicizedBuy(orderedSchemas, bundle.assets, accountAddress, this._wyvernProtocol, this._networkName), calldata = _h.calldata, replacementPattern = _h.replacementPattern;
                        return [4 /*yield*/, this._getPriceParameters(OrderSide.Buy, paymentTokenAddress, expirationTime, startAmount)];
                    case 5:
            ...
            return __generator(this, function (_j) {
                switch (_j.label) {
                    ...
                    case 4:
                        ...
                        _f = encodeAtomicizedSell(orderedSchemas, bundle.assets, accountAddress, this._wyvernProtocol, this._networkName), calldata = _f.calldata, replacementPattern = _f.replacementPattern;
                        return [4 /*yield*/, this._getPriceParameters(OrderSide.Sell, paymentTokenAddress, expirationTime, startAmount, endAmount, waitForHighestBid, englishAuctionReservePrice)];
                    case 5:
    ...
    OpenSeaPort.prototype._makeMatchingOrder = function (_b) {
        ...
        var computeOrderParams = function () {
            if ("asset" in order.metadata) {
                ...
                var atomicized = order.side == OrderSide.Buy
                    ? encodeAtomicizedSell(orderedSchemas, order.metadata.bundle.assets, recipientAddress, _this._wyvernProtocol, _this._networkName)
                    : encodeAtomicizedBuy(orderedSchemas, order.metadata.bundle.assets, recipientAddress, _this._wyvernProtocol, _this._networkName);
                return {
                    target: WyvernProtocol.getAtomicizerContractAddress(_this._networkName),
        ...
        var feeRecipient = order.feeRecipient == NULL_ADDRESS ? OPENSEA_FEE_RECIPIENT : NULL_ADDRESS;
        var matchingOrder = {
        ...
        return __assign(__assign({}, matchingOrder), { hash: getOrderHash(matchingOrder) });
    };
    /**
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 3:
                        ...
                        _e.label = 4;
                    case 4: return [4 /*yield*/, requireOrdersCanMatch(this._getClientsForRead(retries).wyvernProtocol, { buy: buy, sell: sell, accountAddress: accountAddress })];
                    case 5:
                        canMatch = _e.sent();
                        this.logger("Orders matching: ".concat(canMatch));
                        return [4 /*yield*/, requireOrderCalldataCanMatch(this._getClientsForRead(retries).wyvernProtocol, { buy: buy, sell: sell })];
                    case 6:
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        _c.sent();
                        if (!(tokenAddress != NULL_ADDRESS)) return [3 /*break*/, 3];
                        minimumAmount = makeBigNumber(order.basePrice);
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        this._dispatch(EventType.ApproveOrder, { order: order, accountAddress: accountAddress });
                    ...
                    case 1:
                        transactionHash = _b.sent();
                        return [4 /*yield*/, this._confirmTransaction(transactionHash.toString(), EventType.ApproveOrder, "Approving order", function () { return __awaiter(_this, void 0, void 0, function () {
                                var isApproved;
                                return __generator(this, function (_b) {
                                    switch (_b.label) {
                                        case 0: return [4 /*yield*/, this._validateOrder(order)];
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this._wyvernProtocolReadOnly.wyvernExchange.validateOrder_.callAsync([
                            ...
                            order.expirationTime,
                            order.salt,
                        ], order.feeMethod, order.side, order.saleKind, order.howToCall, order.calldata, order.replacementPattern, order.staticExtradata, order.v || 0, order.r || NULL_BLOCK_HASH, order.s || NULL_BLOCK_HASH)];
                    case 1:
                        isValid = _b.sent();
                                ...
                                return __generator(this, function (_c) {
                                    switch (_c.label) {
                                        ...
                                        case 4:
                                            ...
                                            _b = schemaName;
                                            switch (_b) {
                                                case WyvernSchemaName.ERC721: return [3 /*break*/, 5];
                                                case WyvernSchemaName.ERC721v3: return [3 /*break*/, 5];
                                                case WyvernSchemaName.ERC1155: return [3 /*break*/, 5];
                                                case WyvernSchemaName.LegacyEnjin: return [3 /*break*/, 5];
                                                case WyvernSchemaName.ENSShortNameAuction: return [3 /*break*/, 5];
                                                case WyvernSchemaName.ERC20: return [3 /*break*/, 7];
                                            }
                                            return [3 /*break*/, 9];
                                        case 5:
                                            wyNFTAsset = wyAsset;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        tokenAddress = order.paymentToken;
                        if (!(tokenAddress != NULL_ADDRESS)) return [3 /*break*/, 5];
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        minAmount = new BigNumber("quantity" in wyAsset ? wyAsset.quantity : 1);
    ...
    OpenSeaPort.prototype._validateFees = function (totalBuyerFeeBasisPoints, totalSellerFeeBasisPoints) {
        var maxFeePercent = INVERSE_BASIS_POINT / 100;
    ...
    OpenSeaPort.prototype._getTimeParameters = function (expirationTimestamp, listingTimestamp, waitingForBestCounterOrder) {
        ...
        if (expirationTimestamp != 0 &&
            ...
            throw new Error("Expiration time must be at least ".concat(MIN_EXPIRATION_SECONDS, " seconds from now, or zero (non-expiring)."));
        }
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        isEther = tokenAddress == NULL_ADDRESS;
                        return [4 /*yield*/, this.api.getPaymentTokens({
    ...
    OpenSeaPort.prototype._atomicMatch = function (_b) {
        var buy = _b.buy, sell = _b.sell, accountAddress = _b.accountAddress, _c = _b.metadata, metadata = _c === void 0 ? NULL_BLOCK_HASH : _c, makerOrder = _b.makerOrder;
        return __awaiter(this, void 0, void 0, function () {
            var value, shouldValidateBuy, shouldValidateSell, txHash, txnData, args, useFeeWrapper, feeWrapperAddress, wyvernFeeWrapperArgs, wyvernFeeWrapperCalldata, response, feeDataWithEthersBigNum, wyvernArgsWithEthersBigNum, atomicMatchEstimateGas, submitAtomicMatchTransaction, gasEstimate, error_13, error_14;
            var _this = this;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                    ...
                    case 3:
                        ...
                        if (!(buy.paymentToken == NULL_ADDRESS)) return [3 /*break*/, 5];
                        return [4 /*yield*/, this._getRequiredAmountForTakingSellOrder(sell)];
                    case 4:
                        value = _d.sent();
                        _d.label = 5;
                    ...
                    case 7:
                        ...
                        useFeeWrapper = isFeeWrapperFlow(buy, this._networkName) ||
                            isFeeWrapperFlow(sell, this._networkName);
                        feeWrapperAddress = getFeeWrapperAddress(this._networkName);
                        if (!(useFeeWrapper && (makerOrder === null || makerOrder === void 0 ? void 0 : makerOrder.hash))) return [3 /*break*/, 9];
                        return [4 /*yield*/, this.api.getOrderFulfillmentData(makerOrder.hash)];
                    case 8:
                        response = _d.sent();
                        feeDataWithEthersBigNum = response.fulfillment_data.fee_data.map(function (_b) {
                            var recipient = _b[0], amount = _b[1];
                            return [recipient, ethers.BigNumber.from(amount)];
                        });
                        wyvernArgsWithEthersBigNum = args.map(function (arg) {
                        ...
                        _d.label = 9;
                    case 9:
                        atomicMatchEstimateGas = function () { return __awaiter(_this, void 0, void 0, function () {
                            var _b;
                            return __generator(this, function (_c) {
                                switch (_c.label) {
                                    case 0:
                                        if (!(useFeeWrapper && wyvernFeeWrapperArgs)) return [3 /*break*/, 1];
                                        _b = estimateGas(this.web3ReadOnly, {
                                            from: accountAddress,
                                        ...
                                        return [3 /*break*/, 3];
                                    case 1: return [4 /*yield*/, this._wyvernProtocolReadOnly.wyvernExchange.atomicMatch_.estimateGasAsync(args[0], args[1], args[2], args[3], args[4], args[5], args[6], args[7], args[8], args[9], args[10], txnData)];
                                    case 2:
                                        _b = _c.sent();
                                        _c.label = 3;
                        ...
                        submitAtomicMatchTransaction = function () { return __awaiter(_this, void 0, void 0, function () {
                            var _b;
                            return __generator(this, function (_c) {
                                switch (_c.label) {
                                    case 0:
                                        if (!(useFeeWrapper && wyvernFeeWrapperArgs)) return [3 /*break*/, 1];
                                        _b = sendRawTransaction(this.web3, {
                                            from: accountAddress,
                                            to: feeWrapperAddress,
                                            data: wyvernFeeWrapperCalldata,
                                            value: value,
                                        ...
                                        return [3 /*break*/, 3];
                                    case 1: return [4 /*yield*/, this._wyvernProtocol.wyvernExchange.atomicMatch_.sendTransactionAsync(args[0], args[1], args[2], args[3], args[4], args[5], args[6], args[7], args[8], args[9], args[10], txnData)];
                                    case 2:
                                        _b = _c.sent();
                                        _c.label = 3;
                                    case 3: return [2 /*return*/, _b];
                    ...
                    case 10:
                        ...
                        return [4 /*yield*/, atomicMatchEstimateGas()];
                    case 11:
                        gasEstimate = _d.sent();
                    ...
                    case 12:
                        ...
                        throw new Error("Oops, the Ethereum network rejected this transaction :( The OpenSea devs have been alerted, but this problem is typically due an item being locked or untransferrable. The exact error was \"".concat(error_13 instanceof Error
                            ? error_13.message.substr(0, MAX_ERROR_LENGTH)
                            : "", "...\""));
                    case 13:
                        _d.trys.push([13, 15, , 16]);
                        this.logger("Fulfilling order with gas set to ".concat(txnData.gas));
                        return [4 /*yield*/, submitAtomicMatchTransaction()];
                    case 14:
                        txHash = _d.sent();
                        return [3 /*break*/, 16];
                    case 15:
                        ...
                        throw new Error("Failed to authorize transaction: \"".concat(error_14 instanceof Error ? error_14.message : "user denied", "...\""));
                    case 16: return [2 /*return*/, txHash];
                }
            });
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        currentPrice = _b.sent();
                        estimatedPrice = estimateCurrentPrice(sell);
                        maxPrice = BigNumber.max(currentPrice, estimatedPrice);
                        // TODO Why is this not always a big number?
                        sell.takerRelayerFee = makeBigNumber(sell.takerRelayerFee);
                        feePercentage = sell.takerRelayerFee.div(INVERSE_BASIS_POINT);
    ...
    OpenSeaPort.prototype._authorizeOrder = function (order, isFeeWrapperAtomicMatchFlow) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, isContractAddress(this.web3, signerAddress)];
                    case 1:
                    ...
                    case 3:
                        ...
                        _b.sent();
                        return [2 /*return*/, null];
                    case 4: return [4 /*yield*/, personalSignAsync(this.web3, message, signerAddress)];
    ...
    OpenSeaPort.prototype._getSchema = function (schemaName) {
        var schemaName_ = schemaName || WyvernSchemaName.ERC721;
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        if (!(transactionHash == NULL_BLOCK_HASH)) return [3 /*break*/, 4];
                        // This was a smart contract wallet that doesn't know the transaction
                        this._dispatch(EventType.TransactionCreated, { event: event });
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, confirmTransaction(this.web3, transactionHash)];
                    case 5:
                        _b.sent();
                    ...
                    case 6:
                        ...
                        this._dispatch(EventType.TransactionFailed, __assign(__assign({}, transactionEventData), { error: error_16 }));
                        throw error_16;
                    case 7: return [2 /*return*/];
                }
            });
                            ...
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    ...
                                    case 1:
                                        ...
                                        if (wasSuccessful) {
                                            this.logger("Transaction succeeded: ".concat(description));
                                            this._dispatch(EventType.TransactionConfirmed, { event: event });
