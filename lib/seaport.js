...
var OpenSeaPort = /** @class */ (function () {
    ...
    OpenSeaPort.prototype._atomicMatch = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var value, shouldValidateBuy, shouldValidateSell, txHash, txnData, args, useFeeWrapper, feeWrapperAddress, wyvernFeeWrapperArgs, fulfillmentData, atomicMatchEstimateGas, submitAtomicMatchTransaction, gasEstimate, error_13, error_14;
            var _this = this;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                    ...
                    case 8:
                        fulfillmentData = (_c.sent()).fulfillmentData;
