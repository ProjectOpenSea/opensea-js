            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this._authorizeOrder(matchingOrder)];
                    case 1:
                        vrs = _c.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        this._dispatch(types_1.EventType.CreateOrder, { order: order, accountAddress: order.maker, isFeeWrapperFlow: true });
