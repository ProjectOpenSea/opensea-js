...
var OpenSeaPort = /** @class */ (function () {
                ...
                switch (_d.label) {
                    ...
                    case 1:
                        ...
                        order = {
                            ...
                            basePrice: lib_1.WyvernProtocol.toBaseUnitAmount(utils_1.makeBigNumber(amountInEth), token.decimals),
                            extra: lib_1.WyvernProtocol.toBaseUnitAmount(utils_1.makeBigNumber(0), token.decimals),
    ...
    OpenSeaPort.prototype.createSellOrder = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var schema, wyAsset, listingTime, asset, buyerFee, sellerFee, _c, target, calldata, replacementPattern, extraInEth, orderSaleKind, order, hashedOrder, signature, error_2, orderWithSignature;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        schema = this._getSchema();
                    ...
                    case 1:
                        ...
                        order = {
                            ...
                            basePrice: utils_1.makeBigNumber(this.web3.toWei(startAmountInEth, 'ether')).round(),
                            extra: utils_1.makeBigNumber(this.web3.toWei(extraInEth, 'ether')).round(),
                            listingTime: utils_1.makeBigNumber(listingTime),
                            expirationTime: utils_1.makeBigNumber(expirationTime),
                            salt: lib_1.WyvernProtocol.generatePseudoRandomSalt(),
                            metadata: {
    ...
    OpenSeaPort.prototype.createBundleSellOrder = function (_a) {
        var bundleName = _a.bundleName, bundleDescription = _a.bundleDescription, bundleExternalLink = _a.bundleExternalLink, assets = _a.assets, accountAddress = _a.accountAddress, startAmountInEth = _a.startAmountInEth, endAmountInEth = _a.endAmountInEth, _b = _a.expirationTime, expirationTime = _b === void 0 ? 0 : _b;
        return __awaiter(this, void 0, void 0, function () {
            var order, hashedOrder, signature, error_3, orderWithSignature;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        order = this._makeBundleSellOrder({ bundleName: bundleName, bundleDescription: bundleDescription, bundleExternalLink: bundleExternalLink, assets: assets, accountAddress: accountAddress, startAmountInEth: startAmountInEth, endAmountInEth: endAmountInEth, expirationTime: expirationTime });
                        return [4 /*yield*/, this._validateSellOrderParameters({ order: order, accountAddress: accountAddress })];
                    case 1:
                        _c.sent();
                        hashedOrder = __assign({}, order, { hash: utils_1.getOrderHash(order) });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 3:
                        txHash = _c.sent();
                        return [4 /*yield*/, this._confirmTransaction(txHash, types_1.EventType.ApproveCurrency, "Approving fungible tokens for trading")];
                    case 4:
                        _c.sent();
                        return [2 /*return*/, txHash];
                }
    ...
    OpenSeaPort.prototype._initializeProxy = function (accountAddress) {
        return __awaiter(this, void 0, void 0, function () {
            var gasPrice, txnData, gas, transactionHash, proxyAddress;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 2:
                        gas = _a.sent();
                        return [4 /*yield*/, this._wyvernProtocol.wyvernProxyRegistry.registerProxy.sendTransactionAsync(__assign({}, txnData, { gas: this._correctGasAmount(gas) }))];
                    case 3:
                    ...
                    case 4:
                        _a.sent();
                        // Fix for Cipher and any other clients who get receipts too early
                        return [4 /*yield*/, utils_1.delay(800)];
                    case 5:
                        // Fix for Cipher and any other clients who get receipts too early
                        _a.sent();
                        return [4 /*yield*/, this._getProxy(accountAddress)];
    ...
    OpenSeaPort.prototype._makeBundleSellOrder = function (_a) {
        ...
        var wyAssets = assets.map(function (asset) { return utils_1.getWyvernAsset(schema, asset.tokenId, asset.tokenAddress); });
        var bundle = {
            assets: wyAssets,
            name: bundleName,
        ...
        var _c = WyvernSchemas.encodeAtomicizedSell(schema, wyAssets, accountAddress, this._wyvernProtocol.wyvernAtomicizer), calldata = _c.calldata, replacementPattern = _c.replacementPattern;
        // Small offset to account for latency
        var listingTime = Math.round(Date.now() / 1000 - 100);
        var extraInEth = endAmountInEth != null
            ? startAmountInEth - endAmountInEth
            : 0;
        var orderSaleKind = endAmountInEth != null && endAmountInEth !== startAmountInEth
            ? types_1.SaleKind.DutchAuction
            : types_1.SaleKind.FixedPrice;
        return {
            exchange: lib_1.WyvernProtocol.getExchangeContractAddress(this._networkName),
            maker: accountAddress,
            taker: lib_1.WyvernProtocol.NULL_ADDRESS,
            makerRelayerFee: utils_1.makeBigNumber(0),
    ...
    OpenSeaPort.prototype._makeMatchingOrder = function (_a) {
        ...
        var _b = getCalldata(), target = _b.target, calldata = _b.calldata, replacementPattern = _b.replacementPattern;
    ...
    OpenSeaPort.prototype._validateSellOrderParameters = function (_a) {
        var order = _a.order, accountAddress = _a.accountAddress;
        return __awaiter(this, void 0, void 0, function () {
            var schema, wyAssets, tokenAddress, proxyAddress, proxy, minimumAmount, sellValid;
            var _this = this;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        tokenAddress = order.paymentToken;
                        if (!(tokenAddress != lib_1.WyvernProtocol.NULL_ADDRESS)) return [3 /*break*/, 3];
    ...
    OpenSeaPort.prototype._atomicMatch = function (_a) {
        var buy = _a.buy, sell = _a.sell, accountAddress = _a.accountAddress;
        return __awaiter(this, void 0, void 0, function () {
            var value, orderLookupHash, buyValid, sellValid, txHash, gasPrice, txnData, args, gasEstimate, error_6, error_7;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                    ...
                    case 12:
                        ...
                        return [4 /*yield*/, this._wyvernProtocol.wyvernExchange.atomicMatch_.estimateGasAsync(args[0], args[1], args[2], args[3], args[4], args[5], args[6], args[7], args[8], args[9], args[10], args[11])];
                    case 13:
                        gasEstimate = _b.sent();
                    ...
                    case 14:
                        ...
                        throw new Error("Oops, the Ethereum network rejected this transaction :( OpenSea has been alerted, but this problem typically goes away if you try again later. The exact error was \"" + error_6.message.substr(0, MAX_ERROR_LENGTH) + "...\"");
                    case 15:
                        _b.trys.push([15, 17, , 18]);
                        return [4 /*yield*/, this._wyvernProtocol.wyvernExchange.atomicMatch_.sendTransactionAsync(args[0], args[1], args[2], args[3], args[4], args[5], args[6], args[7], args[8], args[9], args[10], args[11])];
                    case 16:
                        txHash = _b.sent();
                        return [3 /*break*/, 18];
                    case 17:
                        ...
                        throw new Error("Failed to authorize transaction: \"" + (error_7.message
                            ? error_7.message
                            : 'user denied') + "...\"");
    ...
    OpenSeaPort.prototype._confirmTransaction = function (transactionHash, event, description) {
        return __awaiter(this, void 0, void 0, function () {
            var transactionEventData, error_8;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 3:
                        ...
                        this._dispatch(types_1.EventType.TransactionFailed, __assign({}, transactionEventData, { error: error_8 }));
                        throw error_8;
