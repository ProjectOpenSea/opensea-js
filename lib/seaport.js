...
var OpenSeaPort = /** @class */ (function () {
     ...
     */
    OpenSeaPort.prototype.setCustomGasPrice = function (gasPrice) {
        this.logger("Setting custom gas price: " + gasPrice + " wei");
        this._customGasPrice = new bignumber_js_1.BigNumber(gasPrice);
    };
    /**
