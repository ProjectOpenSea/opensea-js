...
var OpenSeaPort = /** @class */ (function () {
    ...
    OpenSeaPort.prototype._makeBundleBuyOrder = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var schema, bundle, makerRelayerFee, takerRelayerFee, asset, _d, tokenAddress, tokenId, _e, totalBuyerFeeBPS, totalSellerFeeBPS, _f, calldata, replacementPattern, _g, basePrice, extra, paymentToken, times;
            return __generator(this, function (_h) {
                switch (_h.label) {
                    case 0:
                        accountAddress = utils_1.validateAndFormatWalletAddress(this.web3ReadOnly, accountAddress);
