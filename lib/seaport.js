...
var OpenSeaPort = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        asset = { tokenAddress: tokenAddress, tokenId: tokenId };
                        return [4 /*yield*/, this._makeSellOrder({ asset: asset, accountAddress: accountAddress, startAmount: startAmount, endAmount: endAmount, expirationTime: expirationTime, paymentTokenAddress: paymentTokenAddress, extraBountyBasisPoints: extraBountyBasisPoints, buyerAddress: buyerAddress })];
                    case 1:
                        order = _d.sent();
                    ...
                    case 2:
                        ...
                        _makeAndPostOneSellOrder = function () { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, this._makeSellOrder({ asset: asset, accountAddress: accountAddress, startAmount: startAmount, endAmount: endAmount, expirationTime: expirationTime, paymentTokenAddress: paymentTokenAddress, extraBountyBasisPoints: extraBountyBasisPoints, buyerAddress: buyerAddress })];
                                    case 1:
                                        order = _a.sent();
                                        hashedOrder = __assign({}, order, { hash: utils_1.getOrderHash(order) });
                                        _a.label = 2;
    ...
    OpenSeaPort.prototype.createBundleSellOrder = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0: return [4 /*yield*/, this._makeBundleSellOrder({ bundleName: bundleName, bundleDescription: bundleDescription, bundleExternalLink: bundleExternalLink, assets: assets, accountAddress: accountAddress, startAmount: startAmount, endAmount: endAmount, expirationTime: expirationTime, paymentTokenAddress: paymentTokenAddress, extraBountyBasisPoints: extraBountyBasisPoints, buyerAddress: buyerAddress })];
                    case 1:
                        order = _d.sent();
                        return [4 /*yield*/, this._validateSellOrderParameters({ order: order, accountAddress: accountAddress })];
                    case 2:
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this._getPriceParameters(paymentTokenAddress, startAmount)];
                    case 2:
    ...
    OpenSeaPort.prototype._makeSellOrder = function (_a) {
        var asset = _a.asset, accountAddress = _a.accountAddress, startAmount = _a.startAmount, endAmount = _a.endAmount, _b = _a.expirationTime, expirationTime = _b === void 0 ? 0 : _b, _c = _a.paymentTokenAddress, paymentTokenAddress = _c === void 0 ? utils_1.NULL_ADDRESS : _c, _d = _a.extraBountyBasisPoints, extraBountyBasisPoints = _d === void 0 ? 0 : _d, _e = _a.buyerAddress, buyerAddress = _e === void 0 ? utils_1.NULL_ADDRESS : _e;
        return __awaiter(this, void 0, void 0, function () {
            var schema, wyAsset, listingTime, isEnglishAuction, isPrivate, _f, totalSellerFeeBPS, totalBuyerFeeBPS, sellerBountyBPS, _g, target, calldata, replacementPattern, orderSaleKind, _h, basePrice, extra, feeRecipient;
            return __generator(this, function (_j) {
                switch (_j.label) {
                    case 0:
                        ...
                        wyAsset = utils_1.getWyvernAsset(schema, asset.tokenId, asset.tokenAddress);
                        listingTime = Math.round(Date.now() / 1000 - 100);
                        isEnglishAuction = endAmount == null;
                    ...
                    case 1:
                        _f = _j.sent(), totalSellerFeeBPS = _f.totalSellerFeeBPS, totalBuyerFeeBPS = _f.totalBuyerFeeBPS, sellerBountyBPS = _f.sellerBountyBPS;
                        _g = WyvernSchemas.encodeSell(schema, wyAsset, accountAddress), target = _g.target, calldata = _g.calldata, replacementPattern = _g.replacementPattern;
                        orderSaleKind = endAmount != null && endAmount !== startAmount
                            ? types_1.SaleKind.DutchAuction
                            : types_1.SaleKind.FixedPrice;
                        return [4 /*yield*/, this._getPriceParameters(paymentTokenAddress, startAmount, endAmount)
                            // Use buyer as the maker when it's an English auction, so Wyvern sets prices correctly
                        ];
                    case 2:
                        _h = _j.sent(), basePrice = _h.basePrice, extra = _h.extra;
                        feeRecipient = isEnglishAuction
    ...
    OpenSeaPort.prototype._makeBundleSellOrder = function (_a) {
        var bundleName = _a.bundleName, bundleDescription = _a.bundleDescription, bundleExternalLink = _a.bundleExternalLink, assets = _a.assets, accountAddress = _a.accountAddress, startAmount = _a.startAmount, endAmount = _a.endAmount, _b = _a.expirationTime, expirationTime = _b === void 0 ? 0 : _b, _c = _a.paymentTokenAddress, paymentTokenAddress = _c === void 0 ? utils_1.NULL_ADDRESS : _c, _d = _a.extraBountyBasisPoints, extraBountyBasisPoints = _d === void 0 ? 0 : _d, _e = _a.buyerAddress, buyerAddress = _e === void 0 ? utils_1.NULL_ADDRESS : _e;
        return __awaiter(this, void 0, void 0, function () {
            var schema, wyAssets, bundle, isPrivate, _f, totalSellerFeeBPS, totalBuyerFeeBPS, sellerBountyBPS, _g, calldata, replacementPattern, _h, basePrice, extra, listingTime, orderSaleKind;
            return __generator(this, function (_j) {
                switch (_j.label) {
                    case 0:
                        accountAddress = utils_1.validateAndFormatWalletAddress(accountAddress);
                    ...
                    case 1:
                        _f = _j.sent(), totalSellerFeeBPS = _f.totalSellerFeeBPS, totalBuyerFeeBPS = _f.totalBuyerFeeBPS, sellerBountyBPS = _f.sellerBountyBPS;
                        _g = WyvernSchemas.encodeAtomicizedSell(schema, wyAssets, accountAddress, this._wyvernProtocol.wyvernAtomicizer), calldata = _g.calldata, replacementPattern = _g.replacementPattern;
                        return [4 /*yield*/, this._getPriceParameters(paymentTokenAddress, startAmount, endAmount)
