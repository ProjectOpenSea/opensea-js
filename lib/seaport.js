...
var OpenSeaPort = /** @class */ (function () {
    ...
    OpenSeaPort.prototype._makeBuyOrder = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var schema, wyAsset, metadata, _d, totalBuyerFeeBPS, totalSellerFeeBPS, _e, target, calldata, replacementPattern, _f, basePrice, extra, times;
            return __generator(this, function (_g) {
                switch (_g.label) {
                    case 0:
    ...
    OpenSeaPort.prototype._makeSellOrder = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var schema, wyAsset, isPrivate, _b, totalSellerFeeBPS, totalBuyerFeeBPS, sellerBountyBPS, _c, target, calldata, replacementPattern, orderSaleKind, _d, basePrice, extra, times, feeRecipient;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        accountAddress = utils_1.validateAndFormatWalletAddress(accountAddress);
