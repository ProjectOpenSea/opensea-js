...
var OpenSeaPort = /** @class */ (function () {
    ...
    OpenSeaPort.prototype._atomicMatch = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var protocolInstance, value, orderLookupHash, buyValid, sellValid, currentPrice, estimatedPrice, maxPrice, feePercentage, fee, ordersCanMatch, orderCalldataCanMatch, txHash, error_5;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        protocolInstance = this.wyvernProtocol;
    ...
    OpenSeaPort.prototype._makeMatchingOrder = function (_a) {
        ...
        return __assign({}, matchingOrder, { hash: lib_1.WyvernProtocol.getOrderHashHex(wyvern_1.orderToJSON(matchingOrder)) });
    };
