...
var OpenSeaPort = /** @class */ (function () {
    ...
    OpenSeaPort.prototype.createBuyOrder = function (_a) {
        var tokenId = _a.tokenId, tokenAddress = _a.tokenAddress, accountAddress = _a.accountAddress, startAmount = _a.startAmount, _b = _a.expirationTime, expirationTime = _b === void 0 ? 0 : _b, paymentTokenAddress = _a.paymentTokenAddress, _c = _a.extraBountyBasisPoints, extraBountyBasisPoints = _c === void 0 ? 0 : _c;
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this._makeBuyOrder({ asset: asset, accountAddress: accountAddress, startAmount: startAmount, expirationTime: expirationTime, paymentTokenAddress: paymentTokenAddress, extraBountyBasisPoints: extraBountyBasisPoints })
    ...
    OpenSeaPort.prototype.createSellOrder = function (_a) {
        var tokenId = _a.tokenId, tokenAddress = _a.tokenAddress, accountAddress = _a.accountAddress, startAmount = _a.startAmount, endAmount = _a.endAmount, _b = _a.expirationTime, expirationTime = _b === void 0 ? 0 : _b, _c = _a.shouldWaitForHighestBid, shouldWaitForHighestBid = _c === void 0 ? false : _c, _d = _a.paymentTokenAddress, paymentTokenAddress = _d === void 0 ? utils_1.NULL_ADDRESS : _d, _e = _a.extraBountyBasisPoints, extraBountyBasisPoints = _e === void 0 ? 0 : _e, _f = _a.buyerAddress, buyerAddress = _f === void 0 ? utils_1.NULL_ADDRESS : _f;
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    case 0:
                        asset = { tokenAddress: tokenAddress, tokenId: tokenId };
                        return [4 /*yield*/, this._makeSellOrder({ asset: asset, accountAddress: accountAddress, startAmount: startAmount, endAmount: endAmount, expirationTime: expirationTime, shouldWaitForHighestBid: shouldWaitForHighestBid, paymentTokenAddress: paymentTokenAddress, extraBountyBasisPoints: extraBountyBasisPoints, buyerAddress: buyerAddress })];
                    case 1:
                        order = _g.sent();
    ...
    OpenSeaPort.prototype.createFactorySellOrders = function (_a) {
        var assetId = _a.assetId, factoryAddress = _a.factoryAddress, accountAddress = _a.accountAddress, startAmount = _a.startAmount, endAmount = _a.endAmount, _b = _a.expirationTime, expirationTime = _b === void 0 ? 0 : _b, _c = _a.shouldWaitForHighestBid, shouldWaitForHighestBid = _c === void 0 ? false : _c, _d = _a.paymentTokenAddress, paymentTokenAddress = _d === void 0 ? utils_1.NULL_ADDRESS : _d, _e = _a.extraBountyBasisPoints, extraBountyBasisPoints = _e === void 0 ? 0 : _e, _f = _a.buyerAddress, buyerAddress = _f === void 0 ? utils_1.NULL_ADDRESS : _f, _g = _a.numberOfOrders, numberOfOrders = _g === void 0 ? 1 : _g;
        return __awaiter(this, void 0, void 0, function () {
    ...
    OpenSeaPort.prototype.createBundleSellOrder = function (_a) {
        var bundleName = _a.bundleName, bundleDescription = _a.bundleDescription, bundleExternalLink = _a.bundleExternalLink, assets = _a.assets, accountAddress = _a.accountAddress, startAmount = _a.startAmount, endAmount = _a.endAmount, _b = _a.expirationTime, expirationTime = _b === void 0 ? 0 : _b, _c = _a.shouldWaitForHighestBid, shouldWaitForHighestBid = _c === void 0 ? false : _c, _d = _a.paymentTokenAddress, paymentTokenAddress = _d === void 0 ? utils_1.NULL_ADDRESS : _d, _e = _a.extraBountyBasisPoints, extraBountyBasisPoints = _e === void 0 ? 0 : _e, _f = _a.buyerAddress, buyerAddress = _f === void 0 ? utils_1.NULL_ADDRESS : _f;
        return __awaiter(this, void 0, void 0, function () {
            var order, hashedOrder, signature, error_4, orderWithSignature;
            return __generator(this, function (_g) {
                switch (_g.label) {
                    case 0: return [4 /*yield*/, this._makeBundleSellOrder({ bundleName: bundleName, bundleDescription: bundleDescription, bundleExternalLink: bundleExternalLink, assets: assets, accountAddress: accountAddress, startAmount: startAmount, endAmount: endAmount, expirationTime: expirationTime, shouldWaitForHighestBid: shouldWaitForHighestBid, paymentTokenAddress: paymentTokenAddress, extraBountyBasisPoints: extraBountyBasisPoints, buyerAddress: buyerAddress })];
                    case 1:
                        order = _g.sent();
                        return [4 /*yield*/, this._validateSellOrderParameters({ order: order, accountAddress: accountAddress })];
                    case 2:
    ...
    OpenSeaPort.prototype._makeBuyOrder = function (_a) {
        var asset = _a.asset, accountAddress = _a.accountAddress, startAmount = _a.startAmount, _b = _a.expirationTime, expirationTime = _b === void 0 ? 0 : _b, paymentTokenAddress = _a.paymentTokenAddress, _c = _a.extraBountyBasisPoints, extraBountyBasisPoints = _c === void 0 ? 0 : _c;
        return __awaiter(this, void 0, void 0, function () {
            var schema, wyAsset, metadata, listingTime, _d, totalBuyerFeeBPS, totalSellerFeeBPS, _e, target, calldata, replacementPattern, _f, basePrice, extra;
            return __generator(this, function (_g) {
                switch (_g.label) {
                    case 0:
                        accountAddress = utils_1.validateAndFormatWalletAddress(accountAddress);
                        schema = this._getSchema();
                        ...
                        return [4 /*yield*/, this.computeFees({ assets: [asset], extraBountyBasisPoints: extraBountyBasisPoints, side: types_1.OrderSide.Buy })];
                    case 1:
    ...
    OpenSeaPort.prototype._makeSellOrder = function (_a) {
        var asset = _a.asset, accountAddress = _a.accountAddress, startAmount = _a.startAmount, endAmount = _a.endAmount, expirationTime = _a.expirationTime, shouldWaitForHighestBid = _a.shouldWaitForHighestBid, paymentTokenAddress = _a.paymentTokenAddress, extraBountyBasisPoints = _a.extraBountyBasisPoints, buyerAddress = _a.buyerAddress;
        return __awaiter(this, void 0, void 0, function () {
            var schema, wyAsset, listingTime, isPrivate, _b, totalSellerFeeBPS, totalBuyerFeeBPS, sellerBountyBPS, _c, target, calldata, replacementPattern, orderSaleKind, _d, basePrice, extra, feeRecipient;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        accountAddress = utils_1.validateAndFormatWalletAddress(accountAddress);
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this._getPriceParameters(paymentTokenAddress, expirationTime, startAmount, endAmount, shouldWaitForHighestBid)
                            // Use buyer as the maker when it's an English auction, so Wyvern sets prices correctly
                        ];
                    case 2:
                        _d = _e.sent(), basePrice = _d.basePrice, extra = _d.extra;
                        feeRecipient = shouldWaitForHighestBid
    ...
    OpenSeaPort.prototype._makeBundleSellOrder = function (_a) {
        var bundleName = _a.bundleName, bundleDescription = _a.bundleDescription, bundleExternalLink = _a.bundleExternalLink, assets = _a.assets, accountAddress = _a.accountAddress, startAmount = _a.startAmount, endAmount = _a.endAmount, expirationTime = _a.expirationTime, shouldWaitForHighestBid = _a.shouldWaitForHighestBid, paymentTokenAddress = _a.paymentTokenAddress, extraBountyBasisPoints = _a.extraBountyBasisPoints, buyerAddress = _a.buyerAddress;
        return __awaiter(this, void 0, void 0, function () {
            var schema, wyAssets, bundle, isPrivate, _b, totalSellerFeeBPS, totalBuyerFeeBPS, sellerBountyBPS, _c, calldata, replacementPattern, _d, basePrice, extra, listingTime, orderSaleKind, feeRecipient;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        accountAddress = utils_1.validateAndFormatWalletAddress(accountAddress);
                    ...
                    case 1:
                        _b = _e.sent(), totalSellerFeeBPS = _b.totalSellerFeeBPS, totalBuyerFeeBPS = _b.totalBuyerFeeBPS, sellerBountyBPS = _b.sellerBountyBPS;
                        _c = WyvernSchemas.encodeAtomicizedSell(schema, wyAssets, accountAddress, this._wyvernProtocol.wyvernAtomicizer), calldata = _c.calldata, replacementPattern = _c.replacementPattern;
                        return [4 /*yield*/, this._getPriceParameters(paymentTokenAddress, expirationTime, startAmount, endAmount, shouldWaitForHighestBid)
     ...
     */
    OpenSeaPort.prototype._getPriceParameters = function (tokenAddress, expirationTime, startAmount, endAmount, shouldWaitForHighestCounterOrder) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    OpenSeaPort.prototype._atomicMatch = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        if (!(sell.maker.toLowerCase() == accountAddress.toLowerCase())) return [3 /*break*/, 3];
                        // USER IS THE SELLER
