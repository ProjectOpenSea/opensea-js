...
var OpenSeaPort = /** @class */ (function () {
    ...
    OpenSeaPort.prototype.isAssetTransferrable = function (_a, retries) {
        var tokenId = _a.tokenId, tokenAddress = _a.tokenAddress, asset = _a.asset, fromAddress = _a.fromAddress, toAddress = _a.toAddress, _b = _a.quantity, quantity = _b === void 0 ? 1 : _b, _c = _a.useProxy, useProxy = _c === void 0 ? false : _c, _d = _a.schemaName, schemaName = _d === void 0 ? types_1.WyvernSchemaName.ERC721 : _d;
        if (retries === void 0) { retries = 1; }
        return __awaiter(this, void 0, void 0, function () {
    ...
    OpenSeaPort.prototype._getStaticCallTargetAndExtraData = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        isCheezeWizards = String(asset.tokenAddress).toLowerCase() === String(utils_1.CHEEZE_WIZARDS_GUILD_ADDRESS).toLowerCase() || String(asset.tokenAddress).toLowerCase() === String(utils_1.CHEEZE_WIZARDS_GUILD_RINKEBY_ADDRESS).toLowerCase();
                        isDecentralandEstate = String(asset.tokenAddress).toLowerCase() === String(utils_1.DECENTRALAND_ESTATE_ADDRESS).toLowerCase();
                        isMainnet = this._networkName === types_1.Network.Main;
                        if (!isMainnet) return [3 /*break*/, 1];
                    ...
                    case 1:
                        if (!isCheezeWizards) return [3 /*break*/, 4];
                    ...
                    case 3:
                        ...
                        return [2 /*return*/, {
                                staticTarget: (isMainnet) ? utils_1.STATIC_CALL_CHEEZE_WIZARDS_ADDRESS : utils_1.STATIC_CALL_CHEEZE_WIZARDS_RINKEBY_ADDRESS,
                    ...
                    case 4:
                        if (!(isDecentralandEstate && (isMainnet))) return [3 /*break*/, 7];
                    ...
                    case 7:
                        if (useTxnOriginStaticCall) {
                            return [2 /*return*/, {
                                    staticTarget: (isMainnet) ? utils_1.STATIC_CALL_TX_ORIGIN_ADDRESS : utils_1.STATIC_CALL_TX_ORIGIN_RINKEBY_ADDRESS,
