...
var OpenSeaPort = /** @class */ (function () {
    ...
    function OpenSeaPort(provider, apiConfig, logger) {
        ...
        var networkPrefix = this._networkName + (this._networkName == types_1.Network.Main ? "net" : "");
        var readonlyProvider = new Web3.providers.HttpProvider("https://" + networkPrefix + ".infura.io/v3/" + utils_1.INFURA_KEY);
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this._makeBuyOrder({ asset: asset, accountAddress: accountAddress, startAmount: startAmount, expirationTime: expirationTime, paymentTokenAddress: paymentTokenAddress })
    ...
    OpenSeaPort.prototype.createFactorySellOrders = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            function _makeAndPostOneSellOrder() {
                return __awaiter(this, void 0, void 0, function () {
            ...
            var asset, dummyOrder, range, batches, allOrdersCreated;
            var _this = this;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 3:
                        ...
                        allOrdersCreated = [];
                        batches.forEach(function (subRange) { return __awaiter(_this, void 0, void 0, function () {
                            var batchOrdersCreated;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, Promise.all(subRange.map(_makeAndPostOneSellOrder))];
                                    case 1:
                                        batchOrdersCreated = _a.sent();
                        ...
                        return [2 /*return*/, allOrdersCreated];
                }
            });
        });
    };
    ...
    OpenSeaPort.prototype._makeBuyOrder = function (_a) {
        var asset = _a.asset, accountAddress = _a.accountAddress, startAmount = _a.startAmount, _b = _a.expirationTime, expirationTime = _b === void 0 ? 0 : _b, paymentTokenAddress = _a.paymentTokenAddress;
        return __awaiter(this, void 0, void 0, function () {
            var schema, wyAsset, metadata, listingTime, buyerFee, sellerFee, _c, target, calldata, replacementPattern, paymentToken, _d, basePrice, extra;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        schema = this._getSchema();
    ...
    OpenSeaPort.prototype._makeSellOrder = function (_a) {
        var asset = _a.asset, accountAddress = _a.accountAddress, startAmount = _a.startAmount, endAmount = _a.endAmount, _b = _a.expirationTime, expirationTime = _b === void 0 ? 0 : _b, paymentTokenAddress = _a.paymentTokenAddress;
        return __awaiter(this, void 0, void 0, function () {
            var schema, wyAsset, listingTime, buyerFee, sellerFee, _c, target, calldata, replacementPattern, orderSaleKind, paymentToken, _d, basePrice, extra;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        schema = this._getSchema();
