            ...
            return __generator(this, function (_j) {
                switch (_j.label) {
                    ...
                    case 4:
                        ...
                        _g = schema_1.encodeAtomicizedBuy(orderedSchemas, bundle.assets, accountAddress, this._wyvernProtocol.wyvernAtomicizer), calldata = _g.calldata, replacementPattern = _g.replacementPattern;
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 4:
                        ...
                        _d = schema_1.encodeAtomicizedSell(orderedSchemas, bundle.assets, accountAddress, this._wyvernProtocol.wyvernAtomicizer), calldata = _d.calldata, replacementPattern = _d.replacementPattern;
                        if (!calldata || !replacementPattern) {
                            throw new Error("Failed to encode");
                        }
                        return [4 /*yield*/, this._getPriceParameters(types_1.OrderSide.Sell, paymentTokenAddress, expirationTime, startAmount, endAmount, waitForHighestBid)];
        ...
        var computeOrderParams = function () {
            if ('asset' in order.metadata) {
                ...
                var atomicized = order.side == types_1.OrderSide.Buy
                    ? schema_1.encodeAtomicizedSell(orderedSchemas, order.metadata.bundle.assets, recipientAddress, _this._wyvernProtocol.wyvernAtomicizer)
                    : schema_1.encodeAtomicizedBuy(orderedSchemas, order.metadata.bundle.assets, recipientAddress, _this._wyvernProtocol.wyvernAtomicizer);
                return {
