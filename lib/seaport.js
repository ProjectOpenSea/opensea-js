...
var OpenSeaPort = /** @class */ (function () {
    ...
    OpenSeaPort.prototype.fulfillOrder = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var matchingOrder, _b, buy, sell, metadata, transactionHash, vrs, properlySignedMatchingOrder;
            var _this = this;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        transactionHash = '';
                        debugger;
                        console.log("is fee wrapper flow", utils_1.isFeeWrapperFlow({ buy: buy, sell: sell }, this._networkName));
                        if (!utils_1.isFeeWrapperFlow({ buy: buy, sell: sell }, this._networkName)) return [3 /*break*/, 3];
                        return [4 /*yield*/, this._authorizeOrder(matchingOrder, true)];
                    case 1:
                        vrs = _c.sent();
                        properlySignedMatchingOrder = __assign(__assign({}, matchingOrder), { vrs: vrs });
                        return [4 /*yield*/, this._atomicMatch({
                                buy: properlySignedMatchingOrder.side === types_1.OrderSide.Buy
                                    ? properlySignedMatchingOrder
                                    : buy,
                                sell: properlySignedMatchingOrder.side === types_1.OrderSide.Sell
                                    ? properlySignedMatchingOrder
                                    : sell,
                                accountAddress: accountAddress,
                                metadata: metadata,
                    ...
                    case 4:
                        transactionHash = _c.sent();
                        _c.label = 5;
                    case 5: return [4 /*yield*/, this._confirmTransaction(transactionHash, types_1.EventType.MatchOrders, "Fulfilling order", function () { return __awaiter(_this, void 0, void 0, function () {
                            var isOpen;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                ...
                switch (_b.label) {
                    ...
                    case 6:
                        if (useTxnOriginStaticCall) {
                            ...
                            return [2 /*return*/, {
                                    staticTarget: this._networkName === types_1.Network.Main
                                        ? constants_1.FEE_WRAPPER_ADDRESS_MAINNET
                                        : constants_1.FEE_WRAPPER_ADDRESS_RINKEBY,
                                    staticExtradata: schema_1.encodeCall(contracts_1.getMethod(contracts_1.WyvernFeeWrapper, "expectInTransaction"), []),
                                }];
                        }
                        _b.label = 7;
                    case 7: return [2 /*return*/];
    ...
    OpenSeaPort.prototype._makeMatchingOrder = function (_a) {
        ...
        var feeRecipient = order.feeRecipient == constants_1.NULL_ADDRESS
            ? utils_1.getFeeWrapperAddress(this._networkName)
            : constants_1.NULL_ADDRESS;
        var matchingOrder = {
    ...
    OpenSeaPort.prototype._getBuyFeeParameters = function (totalBuyerFeeBasisPoints, totalSellerFeeBasisPoints, sellOrder) {
        ...
        return {
            ...
            feeRecipient: utils_1.getFeeWrapperAddress(this._networkName),
            feeMethod: types_1.FeeMethod.SplitFee
        };
    };
    ...
    OpenSeaPort.prototype._atomicMatch = function (_a) {
        var buy = _a.buy, sell = _a.sell, accountAddress = _a.accountAddress, _b = _a.metadata, metadata = _b === void 0 ? constants_1.NULL_BLOCK_HASH : _b, makerOrder = _a.makerOrder;
        return __awaiter(this, void 0, void 0, function () {
            var value, shouldValidateBuy, shouldValidateSell, txHash, txnData, args, useFeeWrapper, feeWrapperAddress, wyvernFeeWrapperArgs, wyvernFeeWrapperCalldata, response, feeDataWithEthersBigNum, wyvernArgsWithEthersBigNum, atomicMatchEstimateGas, submitAtomicMatchTransaction, error_13;
            var _this = this;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                    ...
                    case 7:
                        ...
                        useFeeWrapper = utils_1.isFeeWrapperFlow({ buy: buy, sell: sell }, this._networkName);
                        feeWrapperAddress = utils_1.getFeeWrapperAddress(this._networkName);
                    ...
                    case 8:
                        response = _c.sent();
                        feeDataWithEthersBigNum = response.fulfillment_data.fee_data.map(function (_a) {
                            var recipient = _a[0], amount = _a[1];
                            return [recipient, ethers_1.ethers.BigNumber.from(amount)];
                        });
                        wyvernArgsWithEthersBigNum = args.map(function (arg) {
                            return Array.isArray(arg)
                                ? arg.map(function (value) {
                                    return typeof value === 'number' || value instanceof bignumber_js_1.BigNumber
                                        ? ethers_1.ethers.BigNumber.from(value.toString())
                                        : value;
                                })
                                : arg;
                        });
                        ...
                        wyvernFeeWrapperCalldata = new ethers_1.ethers.utils.Interface(contracts_1.WyvernFeeWrapper).encodeFunctionData("atomicMatch_", wyvernFeeWrapperArgs);
                        _c.label = 9;
                    case 9:
                            ...
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    case 0:
                                        ...
                                        _a = utils_1.estimateGas(this.web3ReadOnly, {
                                            from: accountAddress,
                        ...
                        submitAtomicMatchTransaction = function () { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    case 0:
                                        if (!(useFeeWrapper && wyvernFeeWrapperArgs)) return [3 /*break*/, 1];
                                        _a = utils_1.sendRawTransaction(this.web3, {
                                            from: accountAddress,
                                            to: feeWrapperAddress,
                                            data: wyvernFeeWrapperCalldata,
                                            value: value,
                    ...
                    case 12:
                        ...
                        throw new Error("Failed to authorize transaction: \"" + (error_13.message
                            ? error_13.message
                            : 'user denied') + "...\"");
                    case 13: return [2 /*return*/, txHash];
                }
            });
        });
    };
    ...
    OpenSeaPort.prototype._authorizeOrder = function (order, isFeeWrapperAtomicMatchFlow) {
        return __awaiter(this, void 0, void 0, function () {
            var message, signerAddress, makerIsSmartContract, error_14;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        message = order.hash;
                        signerAddress = order.maker;
                        this._dispatch(types_1.EventType.CreateOrder, { order: order, accountAddress: order.maker, isFeeWrapperFlow: isFeeWrapperAtomicMatchFlow });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 6:
                        ...
                        this._dispatch(types_1.EventType.TransactionFailed, __assign(__assign({}, transactionEventData), { error: error_15 }));
                        throw error_15;
                    case 7: return [2 /*return*/];
                }
            });
