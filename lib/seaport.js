...
var OpenSeaPort = /** @class */ (function () {
    ...
    OpenSeaPort.prototype.createBundleBuyOrder = function (_a) {
        var assets = _a.assets, quantities = _a.quantities, accountAddress = _a.accountAddress, startAmount = _a.startAmount, _b = _a.expirationTime, expirationTime = _b === void 0 ? 0 : _b, paymentTokenAddress = _a.paymentTokenAddress, sellOrder = _a.sellOrder, schemaName = _a.schemaName, referrerAddress = _a.referrerAddress;
        return __awaiter(this, void 0, void 0, function () {
                ...
                switch (_d.label) {
                    case 0:
                        ...
                        if (isWyvernAsset) {
                            ...
                            openseaAsset = asset;
                            wyAsset = utils_1.getWyvernAsset(schema, openseaAsset);
                        }
    ...
    OpenSeaPort.prototype._makeBundleBuyOrder = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var schema, quantityBNs, bundle, makerRelayerFee, takerRelayerFee, taker, asset, _d, tokenAddress, tokenId, _e, totalBuyerFeeBPS, totalSellerFeeBPS, _f, calldata, replacementPattern, _g, basePrice, extra, paymentToken, times;
            return __generator(this, function (_h) {
                switch (_h.label) {
                    case 0:
                        accountAddress = utils_1.validateAndFormatWalletAddress(this.web3ReadOnly, accountAddress);
                        ...
                        bundle = utils_1.getWyvernBundle(schema, assets, quantityBNs);
                    ...
                    case 4:
                        ...
                        _h.label = 5;
                    case 5:
                        _f = schema_1.encodeAtomicizedBuy(schema, bundle.assets, accountAddress, this._wyvernProtocol.wyvernAtomicizer), calldata = _f.calldata, replacementPattern = _f.replacementPattern;
    ...
    OpenSeaPort.prototype._makeBundleSellOrder = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var schema, quantityBNs, bundle, isPrivate, asset, _b, tokenAddress, tokenId, _c, totalSellerFeeBPS, totalBuyerFeeBPS, sellerBountyBPS, _d, calldata, replacementPattern, _e, basePrice, extra, paymentToken, times, orderSaleKind, feeRecipient;
            return __generator(this, function (_f) {
                switch (_f.label) {
                    case 0:
                        accountAddress = utils_1.validateAndFormatWalletAddress(this.web3ReadOnly, accountAddress);
                    ...
                    case 3:
                        ...
                        _d = schema_1.encodeAtomicizedSell(schema, bundle.assets, accountAddress, this._wyvernProtocol.wyvernAtomicizer), calldata = _d.calldata, replacementPattern = _d.replacementPattern;
                        if (!calldata || !replacementPattern) {
                            throw new Error("Failed to encode");
                        }
                        return [4 /*yield*/, this._getPriceParameters(types_1.OrderSide.Sell, paymentTokenAddress, expirationTime, startAmount, endAmount, waitForHighestBid)];
        ...
        var computeOrderParams = function () {
            if (order.metadata.asset) {
                ...
                var atomicized = order.side == types_1.OrderSide.Buy
                    ? schema_1.encodeAtomicizedSell(schema, order.metadata.bundle.assets, recipientAddress, _this._wyvernProtocol.wyvernAtomicizer)
                    : schema_1.encodeAtomicizedBuy(schema, order.metadata.bundle.assets, recipientAddress, _this._wyvernProtocol.wyvernAtomicizer);
                return {
