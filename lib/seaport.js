...
var OpenSeaPort = /** @class */ (function () {
    ...
    OpenSeaPort.prototype.createBuyOrder = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0: return [4 /*yield*/, this.api.getAsset(tokenAddress, tokenId)];
                    case 1:
                        asset = _d.sent();
                        if (!asset) {
                    ...
                    case 6:
                        ...
                        this._dispatch(types_1.EventType.OrderDenied, { order: hashedOrder, accountAddress: accountAddress });
    ...
    OpenSeaPort.prototype.createSellOrder = function (_a) {
        var tokenId = _a.tokenId, tokenAddress = _a.tokenAddress, accountAddress = _a.accountAddress, startAmount = _a.startAmount, endAmount = _a.endAmount, _b = _a.expirationTime, expirationTime = _b === void 0 ? 0 : _b, paymentTokenAddress = _a.paymentTokenAddress, _c = _a.bountyBasisPoints, bountyBasisPoints = _c === void 0 ? 0 : _c;
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this._makeSellOrder({ asset: asset, accountAddress: accountAddress, startAmount: startAmount, endAmount: endAmount, expirationTime: expirationTime, paymentTokenAddress: paymentTokenAddress, bountyBasisPoints: bountyBasisPoints })];
                    case 2:
                        order = _d.sent();
    ...
    OpenSeaPort.prototype.createFactorySellOrders = function (_a) {
        var assetId = _a.assetId, factoryAddress = _a.factoryAddress, accountAddress = _a.accountAddress, startAmount = _a.startAmount, endAmount = _a.endAmount, _b = _a.expirationTime, expirationTime = _b === void 0 ? 0 : _b, paymentTokenAddress = _a.paymentTokenAddress, _c = _a.numberOfOrders, numberOfOrders = _c === void 0 ? 1 : _c;
        return __awaiter(this, void 0, void 0, function () {
            var asset, dummyOrder, _makeAndPostOneSellOrder, range, batches, allOrdersCreated, _i, batches_1, subRange, batchOrdersCreated;
            var _this = this;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0: return [4 /*yield*/, this.api.getAsset(factoryAddress, assetId)];
                    case 1:
                        asset = _d.sent();
                        if (!asset) {
                        ...
                        return [4 /*yield*/, this._makeSellOrder({ asset: asset, accountAddress: accountAddress, startAmount: startAmount, endAmount: endAmount, expirationTime: expirationTime, paymentTokenAddress: paymentTokenAddress })];
                    case 2:
                        dummyOrder = _d.sent();
                    ...
                    case 3:
                        ...
                        _makeAndPostOneSellOrder = function () { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, this._makeSellOrder({ asset: asset, accountAddress: accountAddress, startAmount: startAmount, endAmount: endAmount, expirationTime: expirationTime, paymentTokenAddress: paymentTokenAddress })];
                                    case 1:
                                        order = _a.sent();
                                        hashedOrder = __assign({}, order, { hash: utils_1.getOrderHash(order) });
                                        _a.label = 2;
                    ...
                    case 7:
                        _i++;
                        return [3 /*break*/, 4];
                    case 8: return [2 /*return*/, allOrdersCreated];
                }
            });
        });
    };
    ...
    OpenSeaPort.prototype._makeBuyOrder = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var schema, wyAsset, metadata, listingTime, buyerFee, sellerFee, _d, target, calldata, replacementPattern, paymentToken, _e, basePrice, extra;
            return __generator(this, function (_f) {
                switch (_f.label) {
                    case 0:
                        schema = this._getSchema();
                        wyAsset = utils_1.getWyvernAsset(schema, asset.tokenId, asset.assetContract.address);
                        metadata = {
                            asset: wyAsset,
                            schema: schema.name,
                        };
                        ...
                        _d = WyvernSchemas.encodeBuy(schema, wyAsset, accountAddress), target = _d.target, calldata = _d.calldata, replacementPattern = _d.replacementPattern;
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, {
                                ...
                                makerReferrerFee: utils_1.makeBigNumber(bountyBasisPoints),
    ...
    OpenSeaPort.prototype._makeSellOrder = function (_a) {
        var asset = _a.asset, accountAddress = _a.accountAddress, startAmount = _a.startAmount, endAmount = _a.endAmount, _b = _a.expirationTime, expirationTime = _b === void 0 ? 0 : _b, paymentTokenAddress = _a.paymentTokenAddress, _c = _a.bountyBasisPoints, bountyBasisPoints = _c === void 0 ? 0 : _c;
        return __awaiter(this, void 0, void 0, function () {
            var schema, wyAsset, listingTime, buyerFee, sellerFee, _d, target, calldata, replacementPattern, orderSaleKind, paymentToken, _e, basePrice, extra;
            return __generator(this, function (_f) {
                switch (_f.label) {
                    case 0:
                        schema = this._getSchema();
                        ...
                        buyerFee = asset.assetContract.buyerFeeBasisPoints;
                        sellerFee = asset.assetContract.sellerFeeBasisPoints;
                        _d = WyvernSchemas.encodeSell(schema, wyAsset, accountAddress), target = _d.target, calldata = _d.calldata, replacementPattern = _d.replacementPattern;
    ...
    OpenSeaPort.prototype._makeBundleSellOrder = function (_a) {
        var bundleName = _a.bundleName, bundleDescription = _a.bundleDescription, bundleExternalLink = _a.bundleExternalLink, assets = _a.assets, accountAddress = _a.accountAddress, startAmount = _a.startAmount, endAmount = _a.endAmount, _b = _a.expirationTime, expirationTime = _b === void 0 ? 0 : _b, paymentTokenAddress = _a.paymentTokenAddress, _c = _a.bountyBasisPoints, bountyBasisPoints = _c === void 0 ? 0 : _c;
        return __awaiter(this, void 0, void 0, function () {
            var schema, wyAssets, bundle, buyerFee, sellerFee, _d, tokenAddress, tokenId, asset, _e, calldata, replacementPattern, paymentToken, _f, basePrice, extra, listingTime, orderSaleKind;
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 16:
                        ...
                        this._dispatch(types_1.EventType.TransactionDenied, { buy: buy, sell: sell, accountAddress: accountAddress, matchMetadata: metadata });
