...
var OpenSeaPort = /** @class */ (function () {
    ...
    OpenSeaPort.prototype._atomicMatch = function (_a) {
        var buy = _a.buy, sell = _a.sell, accountAddress = _a.accountAddress, _b = _a.metadata, metadata = _b === void 0 ? utils_1.NULL_BLOCK_HASH : _b;
        return __awaiter(this, void 0, void 0, function () {
            var value, shouldValidateBuy, shouldValidateSell, buyValid, sellValid, txHash, gasPrice, txnData, args, gasEstimate, error_10, error_11;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                    ...
                    case 6:
                        if (!shouldValidateBuy) return [3 /*break*/, 8];
                    ...
                    case 7:
                        ...
                        _c.label = 8;
                    case 8:
                        if (!shouldValidateSell) return [3 /*break*/, 10];
                    ...
                    case 9:
                        ...
                        _c.label = 10;
                    case 10: return [4 /*yield*/, this._validateMatch({ buy: buy, sell: sell, accountAddress: accountAddress })];
                    case 11:
                        _c.sent();
                    ...
                    case 15:
                        ...
                        throw new Error("Oops, the Ethereum network rejected this transaction :( The OpenSea devs have been alerted, but this problem is typically due an item being locked or untransferrable. The exact error was \"" + error_10.message.substr(0, utils_1.MAX_ERROR_LENGTH) + "...\"");
                    case 16:
                    ...
                    case 18:
                        ...
                        this._dispatch(types_1.EventType.TransactionDenied, { error: error_11, buy: buy, sell: sell, accountAddress: accountAddress, matchMetadata: metadata });
                        throw new Error("Failed to authorize transaction: \"" + (error_11.message
                            ? error_11.message
                            : 'user denied') + "...\"");
                    case 19: return [2 /*return*/, txHash];
                }
            });
        });
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        this._dispatch(types_1.EventType.TransactionFailed, __assign({}, transactionEventData, { error: error_12 }));
                        throw error_12;
                    case 4: return [2 /*return*/];
                }
            });
