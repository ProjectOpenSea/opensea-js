...
var OpenSeaPort = /** @class */ (function () {
    ...
    OpenSeaPort.prototype._makeMatchingOrder = function (_a) {
        ...
        var matchingOrder = {
            ...
            listingTime: times.listingTime,
            expirationTime: times.expirationTime,
            salt: new bignumber_js_1.BigNumber(Math.floor(Math.random() * 500)),
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 11:
                        if (onlyGetCallArgs) {
                            return [2 /*return*/, [args[0], args[1], args[2], args[3], args[4], args[5], args[6], args[7], args[8], args[9], args[10], txnData]];
                        }
                        _c.label = 12;
                    case 12:
