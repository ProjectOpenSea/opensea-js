...
var OpenSeaPort = /** @class */ (function () {
    ...
    OpenSeaPort.prototype.wrapAssets = function (_a) {
        var tokenIds = _a.tokenIds, tokenAddresses = _a.tokenAddresses, accountAddress = _a.accountAddress;
        return __awaiter(this, void 0, void 0, function () {
            var isMixedBatchOfAssets, assets, gasPrice, txHash;
            var _this = this;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        this._dispatch(types_1.EventType.WrapAssets, { assets: assets, accountAddress: accountAddress });
                        return [4 /*yield*/, this._computeGasPrice()];
                    case 1:
                        gasPrice = _b.sent();
                        return [4 /*yield*/, utils_1.sendRawTransaction(this.web3, {
                                from: accountAddress,
                                to: utils_1.WRAPPED_NFT_LIQUIDATION_PROXY_ADDRESS_MAINNET,
                                value: 0,
    ...
    OpenSeaPort.prototype.unwrapAssets = function (_a) {
        var tokenIds = _a.tokenIds, tokenAddresses = _a.tokenAddresses, destinationAddresses = _a.destinationAddresses, accountAddress = _a.accountAddress;
        return __awaiter(this, void 0, void 0, function () {
            var isMixedBatchOfAssets, assets, gasPrice, txHash;
            var _this = this;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        if (!tokenIds || !destinationAddresses || tokenIds.length != destinationAddresses.length) {
                            throw new Error("The 'tokenIds' and 'destinationAddresses' arrays must exist and have the same length.");
                        }
                        isMixedBatchOfAssets = !tokenAddresses.every(function (val, i, arr) { return val === arr[0]; });
                        assets = _.zipWith(tokenIds, tokenAddresses, function (tokenId, tokenAddress) {
                            return { tokenAddress: tokenAddress, tokenId: tokenId };
                        });
                        this._dispatch(types_1.EventType.UnwrapAssets, { assets: assets, accountAddress: accountAddress });
                        return [4 /*yield*/, this._computeGasPrice()];
                    case 1:
                        gasPrice = _b.sent();
                        return [4 /*yield*/, utils_1.sendRawTransaction(this.web3, {
    ...
    OpenSeaPort.prototype.liquidateAssets = function (_a) {
        var tokenIds = _a.tokenIds, tokenAddresses = _a.tokenAddresses, accountAddress = _a.accountAddress, uniswapSlippageAllowedInBasisPoints = _a.uniswapSlippageAllowedInBasisPoints;
        return __awaiter(this, void 0, void 0, function () {
            var isMixedBatchOfAssets, assets, gasPrice, txHash;
            var _this = this;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        this._dispatch(types_1.EventType.LiquidateAssets, { assets: assets, accountAddress: accountAddress });
                        return [4 /*yield*/, this._computeGasPrice()];
                    case 1:
                        gasPrice = _b.sent();
                        return [4 /*yield*/, utils_1.sendRawTransaction(this.web3, {
                                ...
                                to: utils_1.WRAPPED_NFT_LIQUIDATION_PROXY_ADDRESS_MAINNET,
                                value: 0,
                                data: WyvernSchemas.encodeCall(contracts_1.getMethod(contracts_1.WrappedNFTLiquidationProxy, 'liquidateNFTs'), [tokenIds, tokenAddresses, isMixedBatchOfAssets, uniswapSlippageAllowedInBasisPoints]),
                                gasPrice: gasPrice
                            }, function (error) {
                                _this._dispatch(types_1.EventType.TransactionDenied, { error: error, accountAddress: accountAddress });
                            })];
    ...
    OpenSeaPort.prototype.purchaseAssets = function (_a) {
        var numTokensToBuy = _a.numTokensToBuy, amountInEth = _a.amountInEth, contractAddress = _a.contractAddress, accountAddress = _a.accountAddress;
        return __awaiter(this, void 0, void 0, function () {
    ...
    OpenSeaPort.prototype.createBundleBuyOrder = function (_a) {
        var tokenIds = _a.tokenIds, tokenAddresses = _a.tokenAddresses, accountAddress = _a.accountAddress, startAmount = _a.startAmount, _b = _a.expirationTime, expirationTime = _b === void 0 ? 0 : _b, paymentTokenAddress = _a.paymentTokenAddress, sellOrder = _a.sellOrder, _c = _a.schemaName, schemaName = _c === void 0 ? types_1.WyvernSchemaName.ERC721 : _c;
        return __awaiter(this, void 0, void 0, function () {
    ...
    OpenSeaPort.prototype.createBuyOrder = function (_a) {
        var tokenId = _a.tokenId, tokenAddress = _a.tokenAddress, accountAddress = _a.accountAddress, startAmount = _a.startAmount, _b = _a.expirationTime, expirationTime = _b === void 0 ? 0 : _b, paymentTokenAddress = _a.paymentTokenAddress, sellOrder = _a.sellOrder, _c = _a.schemaName, schemaName = _c === void 0 ? types_1.WyvernSchemaName.ERC721 : _c;
        return __awaiter(this, void 0, void 0, function () {
    ...
    OpenSeaPort.prototype.isAssetTransferrable = function (_a, retries) {
        var tokenId = _a.tokenId, tokenAddress = _a.tokenAddress, fromAddress = _a.fromAddress, toAddress = _a.toAddress, _b = _a.didOwnerApprove, didOwnerApprove = _b === void 0 ? false : _b, _c = _a.schemaName, schemaName = _c === void 0 ? types_1.WyvernSchemaName.ERC721 : _c;
        if (retries === void 0) { retries = 1; }
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        schema = this._getSchema(schemaName);
                        wyAsset = utils_1.getWyvernNFTAsset(schema, tokenId, tokenAddress);
                    ...
                    case 5:
                        _d.sent();
                        return [2 /*return*/, this.isAssetTransferrable({ tokenId: tokenId, tokenAddress: tokenAddress, fromAddress: fromAddress, toAddress: toAddress, didOwnerApprove: didOwnerApprove, schemaName: schemaName }, retries - 1)];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        schema = this._getSchema(schemaName);
                        wyAsset = 'tokenId' in asset
                            ? utils_1.getWyvernNFTAsset(schema, asset.tokenId, asset.tokenAddress)
                        ...
                        if (quantity != 1) {
                            ...
                            abi = utils_1.annotateERC721TransferABI(wyAsset);
                        }
                        else {
                            abi = schema.functions.transfer(wyAsset);
                        }
    ...
    OpenSeaPort.prototype.computeFees = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var asset, totalBuyerFeeBPS, totalSellerFeeBPS, openseaBuyerFeeBPS, openseaSellerFeeBPS, devBuyerFeeBPS, devSellerFeeBPS, transferFee, transferFeeTokenAddress, maxTotalBountyBPS, _d, tokenAddress, tokenId, result, error_10, sellerBountyBPS, bountyTooLarge, errorMessage;
    ...
    OpenSeaPort.prototype._makeBuyOrder = function (_a) {
        var asset = _a.asset, accountAddress = _a.accountAddress, startAmount = _a.startAmount, _b = _a.expirationTime, expirationTime = _b === void 0 ? 0 : _b, paymentTokenAddress = _a.paymentTokenAddress, _c = _a.extraBountyBasisPoints, extraBountyBasisPoints = _c === void 0 ? 0 : _c, sellOrder = _a.sellOrder, schemaName = _a.schemaName;
        return __awaiter(this, void 0, void 0, function () {
