...
var OpenSeaPort = /** @class */ (function () {
    ...
    OpenSeaPort.prototype._makeBundleBuyOrder = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var quantityBNs, schemas, bundle, taker, asset, _d, _e, totalBuyerFeeBasisPoints, totalSellerFeeBasisPoints, _f, makerRelayerFee, takerRelayerFee, makerProtocolFee, takerProtocolFee, makerReferrerFee, feeRecipient, feeMethod, _g, calldata, replacementPattern, _h, basePrice, extra, paymentToken, times;
            var _this = this;
            return __generator(this, function (_j) {
                switch (_j.label) {
                    case 0:
                    ...
                    case 4:
                        ...
                        _g = schema_1.encodeAtomicizedBuy(schemas, bundle.assets, accountAddress, this._wyvernProtocol.wyvernAtomicizer), calldata = _g.calldata, replacementPattern = _g.replacementPattern;
    ...
    OpenSeaPort.prototype._makeBundleSellOrder = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var quantityBNs, bundle, isPrivate, asset, _b, _c, totalSellerFeeBasisPoints, totalBuyerFeeBasisPoints, sellerBountyBasisPoints, schemas, _d, calldata, replacementPattern, _e, basePrice, extra, paymentToken, times, orderSaleKind, _f, makerRelayerFee, takerRelayerFee, makerProtocolFee, takerProtocolFee, makerReferrerFee, feeRecipient;
            var _this = this;
            return __generator(this, function (_g) {
                switch (_g.label) {
                    case 0:
