...
var OpenSeaPort = /** @class */ (function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        transactionHash = '';
                        debugger;
                        console.log("is fee wrapper flow", (0, utils_1.isFeeWrapperFlow)({ buy: buy, sell: sell }, this._networkName));
                        if (!(0, utils_1.isFeeWrapperFlow)({ buy: buy, sell: sell }, this._networkName)) return [3 /*break*/, 3];
    ...
    OpenSeaPort.prototype._atomicMatch = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var value, shouldValidateBuy, shouldValidateSell, txHash, txnData, args, useFeeWrapper, feeWrapperAddress, wyvernFeeWrapperArgs, response, atomicMatchEstimateGas, submitAtomicMatchTransaction, gasEstimate, error_13, error_14;
            var _this = this;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                    ...
                    case 7:
                        ...
                        useFeeWrapper = (0, utils_1.isFeeWrapperFlow)({ buy: buy, sell: sell }, this._networkName);
                            ...
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    case 0:
                                        ...
                                        _a = (0, utils_1.estimateGas)(this.web3ReadOnly, {
                                            from: accountAddress,
                                            to: feeWrapperAddress,
                                            data: (0, schema_1.encodeCall)((0, contracts_1.getMethod)(contracts_1.WyvernFeeWrapper, 'atomicMatch_'), wyvernFeeWrapperArgs),
                                            value: value,
                                        });
                                        return [3 /*break*/, 3];
                        ...
                        submitAtomicMatchTransaction = function () { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    case 0:
                                        if (!(useFeeWrapper && wyvernFeeWrapperArgs)) return [3 /*break*/, 1];
                                        _a = (0, utils_1.sendRawTransaction)(this.web3, {
                                            from: accountAddress,
                                            to: feeWrapperAddress,
                                            data: (0, schema_1.encodeCall)((0, contracts_1.getMethod)(contracts_1.WyvernFeeWrapper, 'atomicMatch_'), wyvernFeeWrapperArgs),
                                            value: value,
