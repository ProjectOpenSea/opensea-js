...
var OpenSeaPort = /** @class */ (function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this._confirmTransaction(transactionHash, types_1.EventType.WrapEth)];
                    case 2:
                        _b.sent();
                        return [2 /*return*/];
                }
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        transactionHash = txHash.toString();
                        return [4 /*yield*/, this._confirmTransaction(transactionHash, types_1.EventType.UnwrapWeth)];
                    case 1:
                        _b.sent();
                        return [2 /*return*/];
                }
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 6:
                        txHash = _d.sent();
                        transactionHash = txHash.toString();
                        return [4 /*yield*/, this._confirmTransaction(transactionHash, types_1.EventType.ApproveAllAssets)];
                    case 7:
                        _d.sent();
                        return [2 /*return*/];
                    case 8:
                    ...
                    case 15:
                        txHash = _d.sent();
                        transactionHash = txHash.toString();
                        return [4 /*yield*/, this._confirmTransaction(transactionHash, types_1.EventType.ApproveAsset)];
                    case 16:
                        _d.sent();
                        return [2 /*return*/];
                    case 17:
    ...
    OpenSeaPort.prototype.approveFungibleToken = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var contractAddress, txHash, transactionHash;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                    ...
                    case 1:
                        txHash = _b.sent();
                        transactionHash = txHash.toString();
                        return [4 /*yield*/, this._confirmTransaction(transactionHash, types_1.EventType.ApproveCurrency)];
                    case 2:
                        _b.sent();
                        return [2 /*return*/];
                }
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.wyvernProtocol.wyvernExchange.orderCalldataCanMatch.callAsync(buy.calldata, buy.replacementPattern, sell.calldata, sell.replacementPattern)];
                    case 2:
    ...
    OpenSeaPort.prototype._atomicMatch = function (_a) {
        var buy = _a.buy, sell = _a.sell, accountAddress = _a.accountAddress;
        return __awaiter(this, void 0, void 0, function () {
            var value, orderLookupHash, buyValid, sellValid, currentPrice, estimatedPrice, maxPrice, feePercentage, fee, txHash, error_5;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                    ...
                    case 11:
                        ...
                        return [4 /*yield*/, this.wyvernProtocol.wyvernExchange.atomicMatch_.sendTransactionAsync([buy.exchange, buy.maker, buy.taker, buy.feeRecipient, buy.target,
