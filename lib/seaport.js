...
var OpenSeaPort = /** @class */ (function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        proxyAddress = _b.sent();
                        _b.label = 3;
                    case 3: return [4 /*yield*/, this._approveAll(wyAssets, fromAddress, proxyAddress)];
                    case 4:
                        _b.sent();
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this._approveAll(wyAssets, fromAddress, proxyAddress)];
                    case 2:
                        _b.sent();
                        calldata = utils_1.encodeAtomicizedTransfer(schema, wyAssets, fromAddress, toAddress, this._wyvernProtocol.wyvernAtomicizer).calldata;
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this._approveAll(wyAssets, accountAddress)
                            // For fulfilling bids,
    ...
    OpenSeaPort.prototype._approveAll = function (wyAssets, accountAddress, proxyAddress) {
        if (proxyAddress === void 0) { proxyAddress = null; }
        return __awaiter(this, void 0, void 0, function () {
            var schema, _a, proxy, contractsWithApproveAll;
            var _this = this;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
