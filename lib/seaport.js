...
var OpenSeaPort = /** @class */ (function () {
    ...
    OpenSeaPort.prototype._validateSellOrderParameters = function (_a) {
        var order = _a.order, accountAddress = _a.accountAddress;
        return __awaiter(this, void 0, void 0, function () {
            var schema, wyAsset, tokenAddress, proxyAddress, where, minimumAmount, sellValid;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        schema = this._getSchema();
                    ...
                    case 2:
                        proxyAddress = _b.sent();
                        _b.label = 3;
                    case 3: return [4 /*yield*/, utils_1.findAsset(this.web3, { account: accountAddress, proxy: proxyAddress, wyAsset: wyAsset, schema: schema })];
                    case 4:
                        where = _b.sent();
                        if (where != 'account') {
                    ...
                    case 5:
                        _b.sent();
                        _b.label = 6;
                    case 6: return [4 /*yield*/, this.approveNonFungibleToken({
                    ...
                    case 7:
                        _b.sent();
                        return [4 /*yield*/, this._wyvernProtocol.wyvernExchange.validateOrderParameters_.callAsync([order.exchange, order.maker, order.taker, order.feeRecipient, order.target, order.staticTarget, order.paymentToken], [order.makerRelayerFee, order.takerRelayerFee, order.makerProtocolFee, order.takerProtocolFee, order.basePrice, order.extra, order.listingTime, order.expirationTime, order.salt], order.feeMethod, order.side, order.saleKind, order.howToCall, order.calldata, order.replacementPattern, order.staticExtradata, { from: accountAddress })];
                    case 8:
                        sellValid = _b.sent();
                        if (!sellValid) {
    ...
    OpenSeaPort.prototype._confirmTransaction = function (transactionHash, event, description) {
        return __awaiter(this, void 0, void 0, function () {
            var transactionEventData, error_6;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 3:
                        ...
                        this._dispatch(types_1.EventType.TransactionFailed, __assign({}, transactionEventData, { error: error_6 }));
                        throw error_6;
