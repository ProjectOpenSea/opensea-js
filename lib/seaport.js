...
var OpenSeaPort = /** @class */ (function () {
    ...
    OpenSeaPort.prototype.isAssetTransferrable = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var tokenContract, erc721, proxy, data, gas, error_9;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        tokenContract = this.web3.eth.contract(tokenAbi);
    ...
    OpenSeaPort.prototype._makeBundleBuyOrder = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var schema, wyAssets, bundle, makerRelayerFee, takerRelayerFee, _d, totalBuyerFeeBPS, totalSellerFeeBPS, _e, calldata, replacementPattern, _f, basePrice, extra, times;
            return __generator(this, function (_g) {
                switch (_g.label) {
                    case 0:
                        accountAddress = utils_1.validateAndFormatWalletAddress(this.web3, accountAddress);
                    ...
                    case 2:
                        ...
                        _g.label = 3;
                    case 3:
                        _e = WyvernSchemas.encodeAtomicizedBuy(schema, wyAssets, accountAddress, this._wyvernProtocol.wyvernAtomicizer), calldata = _e.calldata, replacementPattern = _e.replacementPattern;
                        return [4 /*yield*/, this._getPriceParameters(paymentTokenAddress, expirationTime, startAmount)];
                    case 4:
                        _f = _g.sent(), basePrice = _f.basePrice, extra = _f.extra;
                        times = this._getTimeParameters(expirationTime);
    ...
    OpenSeaPort.prototype._makeBundleSellOrder = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var schema, wyAssets, bundle, isPrivate, _b, totalSellerFeeBPS, totalBuyerFeeBPS, sellerBountyBPS, _c, calldata, replacementPattern, _d, basePrice, extra, times, orderSaleKind, feeRecipient;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        accountAddress = utils_1.validateAndFormatWalletAddress(this.web3, accountAddress);
