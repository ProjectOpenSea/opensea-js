...
var OpenSeaPort = /** @class */ (function () {
    ...
    OpenSeaPort.prototype._makeBundleSellOrder = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var quantityBNs, bundle, isPrivate, _b, totalSellerFeeBasisPoints, totalBuyerFeeBasisPoints, sellerBountyBasisPoints, schemas, _c, calldata, replacementPattern, _d, basePrice, extra, paymentToken, times, orderSaleKind, _e, makerRelayerFee, takerRelayerFee, makerProtocolFee, takerProtocolFee, makerReferrerFee, feeRecipient;
            var _this = this;
            return __generator(this, function (_f) {
                switch (_f.label) {
                    case 0:
                    ...
                    case 1:
                        _b = _f.sent(), totalSellerFeeBasisPoints = _b.totalSellerFeeBasisPoints, totalBuyerFeeBasisPoints = _b.totalBuyerFeeBasisPoints, sellerBountyBasisPoints = _b.sellerBountyBasisPoints;
