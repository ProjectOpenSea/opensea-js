...
var OpenSeaPort = /** @class */ (function () {
    ...
    OpenSeaPort.prototype.isAssetTransferrable = function (_a, retries) {
        ...
        if (retries === void 0) { retries = 1; }
        return __awaiter(this, void 0, void 0, function () {
            var schema, wyAsset, abi, from, proxyAddress, data, gas, error_9;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        if (!asset && tokenAddress && tokenId) {
                        ...
                        schema = this._getSchema(schemaName);
                        wyAsset = utils_1.getWyvernAsset(schema, asset, new bignumber_js_1.BigNumber(quantity));
    ...
    OpenSeaPort.prototype.transfer = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var schema, wyAsset, isCryptoKitties, isOldNFT, abi, gasPrice, data, txHash;
            var _this = this;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        if (!(firstAsset && _.uniqBy(assets, function (a) { return a.tokenAddress; }).length == 1)) return [3 /*break*/, 2];
    ...
    OpenSeaPort.prototype._makeBuyOrder = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var schema, quantityBN, wyAsset, makerRelayerFee, takerRelayerFee, taker, _d, totalBuyerFeeBPS, totalSellerFeeBPS, _e, target, calldata, replacementPattern, _f, basePrice, extra, times;
            return __generator(this, function (_g) {
                switch (_g.label) {
                    case 0:
    ...
    OpenSeaPort.prototype._makeSellOrder = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var schema, quantityBN, wyAsset, isPrivate, _b, totalSellerFeeBPS, totalBuyerFeeBPS, sellerBountyBPS, _c, target, calldata, replacementPattern, orderSaleKind, _d, basePrice, extra, times, feeRecipient, makerRelayerFee, takerRelayerFee;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        accountAddress = utils_1.validateAndFormatWalletAddress(this.web3, accountAddress);
