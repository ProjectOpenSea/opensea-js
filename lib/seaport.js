...
var OpenSeaPort = /** @class */ (function () {
    ...
    OpenSeaPort.prototype._makeBuyOrder = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var schema, quantityBN, wyAsset, makerRelayerFee, takerRelayerFee, taker, openSeaAsset, _d, totalBuyerFeeBPS, totalSellerFeeBPS, _e, target, calldata, replacementPattern, _f, basePrice, extra, times, _g, staticTarget, staticExtradata;
            return __generator(this, function (_h) {
                switch (_h.label) {
                    ...
                    case 5:
                        _f = _h.sent(), basePrice = _f.basePrice, extra = _f.extra;
    ...
    OpenSeaPort.prototype._makeSellOrder = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var schema, quantityBN, wyAsset, isPrivate, openSeaAsset, _b, totalSellerFeeBPS, totalBuyerFeeBPS, sellerBountyBPS, _c, target, calldata, replacementPattern, orderSaleKind, _d, basePrice, extra, times, feeRecipient, makerRelayerFee, takerRelayerFee, _e, staticTarget, staticExtradata;
            return __generator(this, function (_f) {
                switch (_f.label) {
                    case 0:
                        accountAddress = utils_1.validateAndFormatWalletAddress(this.web3ReadOnly, accountAddress);
                    ...
                    case 3:
                        _d = _f.sent(), basePrice = _d.basePrice, extra = _d.extra;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        isCheezeWizards = [
                            utils_1.CHEEZE_WIZARDS_GUILD_ADDRESS.toLowerCase(),
                            utils_1.CHEEZE_WIZARDS_GUILD_RINKEBY_ADDRESS.toLowerCase()
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 2:
                        ...
                        contract_1 = this.web3ReadOnly.eth.contract([abi_1]).at(abi_1.target);
                    ...
                    case 6:
                        ...
                        contract_2 = this.web3ReadOnly.eth.contract([abi_2]).at(abi_2.target);
