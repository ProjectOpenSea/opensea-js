...
var OpenSeaPort = /** @class */ (function () {
    ...
    OpenSeaPort.prototype._makeBuyOrder = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var schema, wyAsset, metadata, listingTime, _d, totalBuyerFeeBPS, totalSellerFeeBPS, _e, target, calldata, replacementPattern, paymentToken, _f, basePrice, extra;
    ...
    OpenSeaPort.prototype._makeSellOrder = function (_a) {
        var asset = _a.asset, accountAddress = _a.accountAddress, startAmount = _a.startAmount, endAmount = _a.endAmount, _b = _a.expirationTime, expirationTime = _b === void 0 ? 0 : _b, paymentTokenAddress = _a.paymentTokenAddress, _c = _a.extraBountyBasisPoints, extraBountyBasisPoints = _c === void 0 ? 0 : _c, buyerAddress = _a.buyerAddress;
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    case 0:
                        ...
                        wyAsset = utils_1.getWyvernAsset(schema, asset.tokenId, asset.tokenAddress);
                        listingTime = Math.round(Date.now() / 1000 - 100);
                        return [4 /*yield*/, this.computeFees({ assets: [asset], side: types_1.OrderSide.Sell, isPrivate: !!buyerAddress, extraBountyBasisPoints: extraBountyBasisPoints })];
                    case 1:
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.computeFees({ assets: assets, side: types_1.OrderSide.Sell, isPrivate: !!buyerAddress, extraBountyBasisPoints: extraBountyBasisPoints })];
                    case 1:
                        _d = _g.sent(), totalSellerFeeBPS = _d.totalSellerFeeBPS, totalBuyerFeeBPS = _d.totalBuyerFeeBPS, sellerBountyBPS = _d.sellerBountyBPS;
