...
var OpenSeaPort = /** @class */ (function () {
    ...
    OpenSeaPort.prototype.createBundleBuyOrder = function (_a) {
        var tokenIds = _a.tokenIds, tokenAddresses = _a.tokenAddresses, accountAddress = _a.accountAddress, startAmount = _a.startAmount, _b = _a.expirationTime, expirationTime = _b === void 0 ? 0 : _b, paymentTokenAddress = _a.paymentTokenAddress, sellOrder = _a.sellOrder;
        return __awaiter(this, void 0, void 0, function () {
            var assets, order, hashedOrder, signature, error_1, orderWithSignature;
    ...
    OpenSeaPort.prototype.createBuyOrder = function (_a) {
        var tokenId = _a.tokenId, tokenAddress = _a.tokenAddress, accountAddress = _a.accountAddress, startAmount = _a.startAmount, _b = _a.expirationTime, expirationTime = _b === void 0 ? 0 : _b, paymentTokenAddress = _a.paymentTokenAddress, sellOrder = _a.sellOrder;
        return __awaiter(this, void 0, void 0, function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    case 0:
                        asset = { tokenAddress: tokenAddress, tokenId: tokenId };
                        return [4 /*yield*/, this._makeSellOrder({ asset: asset, accountAddress: accountAddress, startAmount: startAmount, endAmount: endAmount, expirationTime: expirationTime, waitForHighestBid: waitForHighestBid, paymentTokenAddress: paymentTokenAddress, extraBountyBasisPoints: extraBountyBasisPoints, buyerAddress: buyerAddress })];
                    case 1:
                        order = _g.sent();
            ...
            return __generator(this, function (_h) {
                switch (_h.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this._makeSellOrder({ asset: assets[0], accountAddress: accountAddress, startAmount: startAmount, endAmount: endAmount, expirationTime: expirationTime, waitForHighestBid: waitForHighestBid, paymentTokenAddress: paymentTokenAddress, extraBountyBasisPoints: extraBountyBasisPoints, buyerAddress: buyerAddress })];
                    case 1:
                        dummyOrder = _h.sent();
                    ...
                    case 2:
                        ...
                        _makeAndPostOneSellOrder = function (asset) { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, this._makeSellOrder({ asset: asset, accountAddress: accountAddress, startAmount: startAmount, endAmount: endAmount, expirationTime: expirationTime, waitForHighestBid: waitForHighestBid, paymentTokenAddress: paymentTokenAddress, extraBountyBasisPoints: extraBountyBasisPoints, buyerAddress: buyerAddress })];
                                    case 1:
                                        order = _a.sent();
                                        hashedOrder = __assign({}, order, { hash: utils_1.getOrderHash(order) });
                                        _a.label = 2;
    ...
    OpenSeaPort.prototype.approveNonFungibleToken = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var schema, tokenContract, erc721, isApprovedCheckData, isApprovedForAllCallHash, isApprovedForAll, gasPrice, txHash, error_6, approvedAddr, gasPrice, txHash, error_7;
            var _this = this;
                ...
                switch (_e.label) {
                    ...
                    case 15:
                        ...
                        this._dispatch(types_1.EventType.ApproveAsset, {
                            accountAddress: accountAddress,
                            proxyAddress: proxyAddress,
                            asset: utils_1.getWyvernERC721Asset(schema, tokenId, tokenAddress)
                        });
                        return [4 /*yield*/, this._computeGasPrice()];
                    case 16:
                        gasPrice = _e.sent();
    ...
    OpenSeaPort.prototype.isAssetTransferrable = function (_a, retries) {
        var tokenId = _a.tokenId, tokenAddress = _a.tokenAddress, fromAddress = _a.fromAddress, toAddress = _a.toAddress, _b = _a.didOwnerApprove, didOwnerApprove = _b === void 0 ? false : _b, _c = _a.tokenAbi, tokenAbi = _c === void 0 ? contracts_1.ERC721 : _c;
        if (retries === void 0) { retries = 1; }
        return __awaiter(this, void 0, void 0, function () {
            var tokenContract, erc721, to, from, proxyAddress, data, gas, error_9;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 1:
                        ...
                        to = tokenAddress;
                        from = fromAddress;
                        if (!didOwnerApprove) return [3 /*break*/, 3];
                    ...
                    case 7:
                        _d.sent();
                        return [2 /*return*/, this.isAssetTransferrable({ tokenId: tokenId, tokenAddress: tokenAddress, fromAddress: fromAddress, toAddress: toAddress, didOwnerApprove: didOwnerApprove, tokenAbi: tokenAbi }, retries - 1)];
    ...
    OpenSeaPort.prototype.transferOne = function (_a) {
        var _b = _a.schemaName, schemaName = _b === void 0 ? types_1.WyvernSchemaName.ERC721 : _b, asset = _a.asset, fromAddress = _a.fromAddress, toAddress = _a.toAddress;
        return __awaiter(this, void 0, void 0, function () {
            var schema, abi, recipient, gasPrice, txHash;
            var _this = this;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        recipient = abi.inputs.filter(function (i) { return i.kind === 'replaceable'; })[0];
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, utils_1.sendRawTransaction(this.web3, {
                                from: fromAddress,
                                to: abi.target,
                                data: WyvernSchemas.encodeCall(abi, abi.inputs.map(function (i) { return i.value.toString(); })),
                                gasPrice: gasPrice
                            }, function (error) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        schema = this._getSchema();
                        wyAssets = assets.map(function (asset) { return utils_1.getWyvernERC721Asset(schema, asset.tokenId, asset.tokenAddress); });
    ...
    OpenSeaPort.prototype.computeFees = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var totalBuyerFeeBPS, totalSellerFeeBPS, openseaBuyerFeeBPS, openseaSellerFeeBPS, devBuyerFeeBPS, devSellerFeeBPS, maxTotalBountyBPS, _d, tokenAddress, tokenId, asset, sellerBountyBPS, bountyTooLarge, errorMessage;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        ...
                        if (!(!assetContract && assets && !isPrivate && _.uniqBy(assets, function (a) { return a.tokenAddress; }).length == 1)) return [3 /*break*/, 2];
    ...
    OpenSeaPort.prototype._makeBuyOrder = function (_a) {
        var asset = _a.asset, accountAddress = _a.accountAddress, startAmount = _a.startAmount, _b = _a.expirationTime, expirationTime = _b === void 0 ? 0 : _b, paymentTokenAddress = _a.paymentTokenAddress, _c = _a.extraBountyBasisPoints, extraBountyBasisPoints = _c === void 0 ? 0 : _c, sellOrder = _a.sellOrder;
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    case 0:
                        ...
                        schema = this._getSchema();
                        wyAsset = utils_1.getWyvernERC721Asset(schema, asset.tokenId, asset.tokenAddress);
    ...
    OpenSeaPort.prototype._makeSellOrder = function (_a) {
        var asset = _a.asset, accountAddress = _a.accountAddress, startAmount = _a.startAmount, endAmount = _a.endAmount, expirationTime = _a.expirationTime, waitForHighestBid = _a.waitForHighestBid, paymentTokenAddress = _a.paymentTokenAddress, extraBountyBasisPoints = _a.extraBountyBasisPoints, buyerAddress = _a.buyerAddress;
        return __awaiter(this, void 0, void 0, function () {
    ...
    OpenSeaPort.prototype._makeBundleBuyOrder = function (_a) {
        var assets = _a.assets, accountAddress = _a.accountAddress, startAmount = _a.startAmount, _b = _a.expirationTime, expirationTime = _b === void 0 ? 0 : _b, paymentTokenAddress = _a.paymentTokenAddress, _c = _a.extraBountyBasisPoints, extraBountyBasisPoints = _c === void 0 ? 0 : _c, sellOrder = _a.sellOrder;
        return __awaiter(this, void 0, void 0, function () {
    ...
    OpenSeaPort.prototype._validateMatch = function (_a, retries) {
        ...
        if (retries === void 0) { retries = 1; }
        return __awaiter(this, void 0, void 0, function () {
            var buyValid, sellValid, ordersCanMatch, orderCalldataCanMatch, error_10;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        _d.trys.push([0, 7, , 9]);
                        if (!shouldValidateBuy) return [3 /*break*/, 2];
                        return [4 /*yield*/, this._wyvernProtocolReadOnly.wyvernExchange.validateOrder_.callAsync([buy.exchange, buy.maker, buy.taker, buy.feeRecipient, buy.target, buy.staticTarget, buy.paymentToken], [buy.makerRelayerFee, buy.takerRelayerFee, buy.makerProtocolFee, buy.takerProtocolFee, buy.basePrice, buy.extra, buy.listingTime, buy.expirationTime, buy.salt], buy.feeMethod, buy.side, buy.saleKind, buy.howToCall, buy.calldata, buy.replacementPattern, buy.staticExtradata, buy.v || 0, buy.r || '0x', buy.s || '0x', { from: accountAddress })];
                    case 1:
                        buyValid = _d.sent();
                ...
                switch (_d.label) {
                    ...
                    case 4:
                        ...
                        return [2 /*return*/, Promise.all(wyAssets.map(function (wyAsset) { return __awaiter(_this, void 0, void 0, function () {
                                var where, wyNFTAsset;
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0: return [4 /*yield*/, utils_1.findAsset(this.web3, { account: accountAddress, proxy: proxy, wyAsset: wyAsset, schema: schema })];
                                        case 1:
                                            where = _a.sent();
                                            if (where != types_1.WyvernAssetLocation.Account && where != types_1.WyvernAssetLocation.Proxy) {
                                                // small todo: handle the 'proxy' case, which shouldn't happen ever anyway
                                                throw new Error('You do not own this asset.');
                                            }
                                            if (schema.name != types_1.WyvernSchemaName.ERC721) {
                                                // Handle non-NFTs
                                                if (where != types_1.WyvernAssetLocation.Proxy) {
                                                    return [2 /*return*/, this.transferOne({
    ...
    OpenSeaPort.prototype._atomicMatch = function (_a) {
        var buy = _a.buy, sell = _a.sell, accountAddress = _a.accountAddress, _b = _a.metadata, metadata = _b === void 0 ? utils_1.NULL_BLOCK_HASH : _b;
        return __awaiter(this, void 0, void 0, function () {
            var value, shouldValidateBuy, shouldValidateSell, txHash, gasPrice, txnData, args, gasEstimate, error_11, error_12;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                    ...
                    case 11:
                        ...
                        throw new Error("Oops, the Ethereum network rejected this transaction :( The OpenSea devs have been alerted, but this problem is typically due an item being locked or untransferrable. The exact error was \"" + error_11.message.substr(0, utils_1.MAX_ERROR_LENGTH) + "...\"");
                    case 12:
                    ...
                    case 14:
                        ...
                        this._dispatch(types_1.EventType.TransactionDenied, { error: error_12, buy: buy, sell: sell, accountAddress: accountAddress, matchMetadata: metadata });
                        throw new Error("Failed to authorize transaction: \"" + (error_12.message
                            ? error_12.message
                            : 'user denied') + "...\"");
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        this._dispatch(types_1.EventType.TransactionFailed, __assign({}, transactionEventData, { error: error_13 }));
                        throw error_13;
