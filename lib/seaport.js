...
var OpenSeaPort = /** @class */ (function () {
    ...
    OpenSeaPort.prototype._makeSellOrder = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var schema, wyAsset, isPrivate, nfts, _b, totalSellerFeeBPS, totalBuyerFeeBPS, sellerBountyBPS, _c, target, calldata, replacementPattern, orderSaleKind, _d, basePrice, extra, times, feeRecipient, makerRelayerFee, takerRelayerFee;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        ...
                        nfts = 'tokenId' in asset
                            ? [asset]
                            : undefined;
                        return [4 /*yield*/, this.computeFees({ assets: nfts, side: types_1.OrderSide.Sell, isPrivate: isPrivate, extraBountyBasisPoints: extraBountyBasisPoints })];
                    case 1:
