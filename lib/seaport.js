...
var OpenSeaPort = /** @class */ (function () {
                ...
                switch (_c.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, utils_1.sendRawTransaction(this.web3, {
                                from: accountAddress,
                                to: tokenAddress,
                                data: schema_1.encodeCall(contracts_1.getMethod(contracts_1.ERC20, 'approve'), [proxyAddress, minimumAmount.toString()]),
                                gasPrice: gasPrice
                            }, function (error) {
                                _this._dispatch(types_1.EventType.TransactionDenied, { error: error, accountAddress: accountAddress });
                            })];
                                ...
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        ...
                                        case 1:
                                            ...
                                            return [2 /*return*/, newlyApprovedAmount.toNumber() >= minimumAmount.toNumber()];
                                    }
                                });
                            }); })];
                    case 4:
    ...
    OpenSeaPort.prototype.transferAll = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var schemaNames, wyAssets, calldata, proxyAddress, gasPrice, txHash;
            var _this = this;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        calldata = schema_1.encodeAtomicizedTransfer(schemaNames.map(function (name) { return _this._getSchema(name); }), wyAssets, fromAddress, toAddress, this._wyvernProtocol.wyvernAtomicizer).calldata;
                        return [4 /*yield*/, this._getProxy(fromAddress)];
                    case 1:
                        proxyAddress = _c.sent();
                        if (!!proxyAddress) return [3 /*break*/, 3];
    ...
    OpenSeaPort.prototype.computeFees = function (_a) {
        var asset = _a.asset, fees = _a.fees, side = _a.side, accountAddress = _a.accountAddress, _b = _a.isPrivate, isPrivate = _b === void 0 ? false : _b, _c = _a.extraBountyBasisPoints, extraBountyBasisPoints = _c === void 0 ? 0 : _c;
        return __awaiter(this, void 0, void 0, function () {
            var openseaBuyerFeeBasisPoints, openseaSellerFeeBasisPoints, devBuyerFeeBasisPoints, devSellerFeeBasisPoints, transferFee, transferFeeTokenAddress, maxTotalBountyBPS, result, error_9, sellerBountyBPS, bountyTooLarge, errorMessage;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
    ...
    OpenSeaPort.prototype._estimateGasForTransfer = function (_a) {
        var assets = _a.assets, fromAddress = _a.fromAddress, toAddress = _a.toAddress, _b = _a.schemaName, schemaName = _b === void 0 ? types_1.WyvernSchemaName.ERC721 : _b;
        return __awaiter(this, void 0, void 0, function () {
            var schemaNames, wyAssets, proxyAddress, calldata;
            var _this = this;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
    ...
    OpenSeaPort.prototype._makeBuyOrder = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var schema, quantityBN, wyAsset, makerRelayerFee, takerRelayerFee, taker, openSeaAsset, _d, totalBuyerFeeBasisPoints, totalSellerFeeBasisPoints, _e, target, calldata, replacementPattern, _f, basePrice, extra, paymentToken, times, _g, staticTarget, staticExtradata;
            return __generator(this, function (_h) {
                switch (_h.label) {
                    ...
                    case 3:
                        _d = _h.sent(), totalBuyerFeeBasisPoints = _d.totalBuyerFeeBasisPoints, totalSellerFeeBasisPoints = _d.totalSellerFeeBasisPoints;
    ...
    OpenSeaPort.prototype._makeSellOrder = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var schema, quantityBN, wyAsset, isPrivate, openSeaAsset, _b, totalSellerFeeBasisPoints, totalBuyerFeeBasisPoints, sellerBountyBPS, _c, target, calldata, replacementPattern, orderSaleKind, _d, basePrice, extra, paymentToken, times, _e, makerRelayerFee, takerRelayerFee, makerProtocolFee, takerProtocolFee, makerReferrerFee, feeRecipient, _f, staticTarget, staticExtradata;
            return __generator(this, function (_g) {
                switch (_g.label) {
                    case 0:
                        accountAddress = utils_1.validateAndFormatWalletAddress(this.web3ReadOnly, accountAddress);
                    ...
                    case 2:
                        _b = _g.sent(), totalSellerFeeBasisPoints = _b.totalSellerFeeBasisPoints, totalBuyerFeeBasisPoints = _b.totalBuyerFeeBasisPoints, sellerBountyBPS = _b.sellerBountyBPS;
                    ...
                    case 3:
                        ...
                        _e = this._getFeeParameters(totalBuyerFeeBasisPoints, totalSellerFeeBasisPoints, waitForHighestBid, sellerBountyBPS), makerRelayerFee = _e.makerRelayerFee, takerRelayerFee = _e.takerRelayerFee, makerProtocolFee = _e.makerProtocolFee, takerProtocolFee = _e.takerProtocolFee, makerReferrerFee = _e.makerReferrerFee, feeRecipient = _e.feeRecipient;
    ...
    OpenSeaPort.prototype._makeBundleBuyOrder = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var quantityBNs, schemas, bundle, makerRelayerFee, takerRelayerFee, taker, _d, totalBuyerFeeBasisPoints, totalSellerFeeBasisPoints, _e, calldata, replacementPattern, _f, basePrice, extra, paymentToken, times;
            var _this = this;
            return __generator(this, function (_g) {
                switch (_g.label) {
                    case 0:
                        ...
                        taker = sellOrder.maker;
                        return [3 /*break*/, 3];
                    case 1: return [4 /*yield*/, this.computeFees({ fees: collection, extraBountyBasisPoints: extraBountyBasisPoints, side: types_1.OrderSide.Buy })];
                    case 2:
                        _d = _g.sent(), totalBuyerFeeBasisPoints = _d.totalBuyerFeeBasisPoints, totalSellerFeeBasisPoints = _d.totalSellerFeeBasisPoints;
                        makerRelayerFee = utils_1.makeBigNumber(totalBuyerFeeBasisPoints);
                        takerRelayerFee = utils_1.makeBigNumber(totalSellerFeeBasisPoints);
                        taker = constants_1.NULL_ADDRESS;
                        _g.label = 3;
                    case 3:
                        _e = schema_1.encodeAtomicizedBuy(schemas, bundle.assets, accountAddress, this._wyvernProtocol.wyvernAtomicizer), calldata = _e.calldata, replacementPattern = _e.replacementPattern;
                        if (!calldata || !replacementPattern) {
                            throw new Error("Failed to encode");
                        }
                        return [4 /*yield*/, this._getPriceParameters(types_1.OrderSide.Buy, paymentTokenAddress, expirationTime, startAmount)];
                    case 4:
                        _f = _g.sent(), basePrice = _f.basePrice, extra = _f.extra, paymentToken = _f.paymentToken;
                        times = this._getTimeParameters(expirationTime);
                        return [2 /*return*/, {
                                exchange: wyvern_js_1.WyvernProtocol.getExchangeContractAddress(this._networkName),
                                maker: accountAddress,
    ...
    OpenSeaPort.prototype._makeBundleSellOrder = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var quantityBNs, bundle, isPrivate, _b, totalSellerFeeBasisPoints, totalBuyerFeeBasisPoints, sellerBountyBPS, schemas, _c, calldata, replacementPattern, _d, basePrice, extra, paymentToken, times, orderSaleKind, _e, makerRelayerFee, takerRelayerFee, makerProtocolFee, takerProtocolFee, makerReferrerFee, feeRecipient;
            var _this = this;
            return __generator(this, function (_f) {
                switch (_f.label) {
                    case 0:
                        ...
                        isPrivate = buyerAddress != constants_1.NULL_ADDRESS;
                        return [4 /*yield*/, this.computeFees({ fees: collection, side: types_1.OrderSide.Sell, isPrivate: isPrivate, extraBountyBasisPoints: extraBountyBasisPoints })];
                    case 1:
                        _b = _f.sent(), totalSellerFeeBasisPoints = _b.totalSellerFeeBasisPoints, totalBuyerFeeBasisPoints = _b.totalBuyerFeeBasisPoints, sellerBountyBPS = _b.sellerBountyBPS;
                        schemas = bundle.schemas.map(function (name) { return _this._getSchema(name); });
                        _c = schema_1.encodeAtomicizedSell(schemas, bundle.assets, accountAddress, this._wyvernProtocol.wyvernAtomicizer), calldata = _c.calldata, replacementPattern = _c.replacementPattern;
                        if (!calldata || !replacementPattern) {
                            throw new Error("Failed to encode");
                        }
                        return [4 /*yield*/, this._getPriceParameters(types_1.OrderSide.Sell, paymentTokenAddress, expirationTime, startAmount, endAmount, waitForHighestBid)];
    ...
    OpenSeaPort.prototype._getFeeParameters = function (totalBuyerFeeBasisPoints, totalSellerFeeBasisPoints, waitForHighestBid, sellerBountyBPS) {
        if (sellerBountyBPS === void 0) { sellerBountyBPS = 0; }
