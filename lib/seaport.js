...
var OpenSeaPort = /** @class */ (function () {
    ...
    OpenSeaPort.prototype._getPriceParameters = function (tokenAddress, expirationTime, startAmount, endAmount, waitingForBestCounterOrder) {
        return __awaiter(this, void 0, void 0, function () {
            var priceDiff, isEther, tokens, token, minimumExpirationTime, basePrice, extra;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        tokens = _a.sent();
                        token = tokens[0];
                        minimumExpirationTime = Date.now() / 1000 + utils_1.MIN_EXPIRATION_SECONDS;
                        // Validation
                        if (expirationTime != 0 && expirationTime < minimumExpirationTime) {
                            throw new Error("Expiration time must be at least " + utils_1.MIN_EXPIRATION_SECONDS + " from now, or zero (non-expiring).");
                        }
