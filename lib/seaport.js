...
var OpenSeaPort = /** @class */ (function () {
    ...
    OpenSeaPort.prototype.getFungibleTokens = function (_a) {
        var symbol = _a.symbol, address = _a.address, _b = _a.officiallySupported, officiallySupported = _b === void 0 ? false : _b;
        var allTokens = [
        ...
        return allTokens.filter(function (t) {
            ...
            if (officiallySupported && !_.includes(utils_1.OFFICIALLY_SUPPORTED_ERC20_TOKEN_SYMBOLS, t.symbol)) {
                return false;
            }
            return true;
        });
