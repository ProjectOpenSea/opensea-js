...
var OpenSeaPort = /** @class */ (function () {
    ...
    OpenSeaPort.prototype.approveNonFungibleToken = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var schema, tokenContract, erc721, isApprovedForAllRaw, isApprovedForAll, gasPrice, txHash, error_6, approvedAddr, gasPrice, txHash, error_7;
            var _this = this;
            return __generator(this, function (_f) {
                switch (_f.label) {
                    ...
                    case 2:
                        ...
                        _f.label = 3;
                    case 3: return [4 /*yield*/, utils_1.rawCall(this.web3, {
                            from: accountAddress,
                            to: erc721.address,
                            data: erc721.isApprovedForAll.getData(accountAddress, proxyAddress)
                        })];
                    case 4:
                        isApprovedForAllRaw = _f.sent();
                        isApprovedForAll = parseInt(isApprovedForAllRaw);
