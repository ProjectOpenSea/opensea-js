...
var OpenSeaSDK = /** @class */ (function () {
    ...
    OpenSeaSDK.prototype.fulfillOrder = function (_b) {
        var order = _b.order, accountAddress = _b.accountAddress, recipientAddress = _b.recipientAddress, _c = _b.dryRun, dryRun = _c === void 0 ? false : _c;
        return __awaiter(this, void 0, void 0, function () {
            var isPrivateListing, transactionHash, _d, _e, executeAllActions, actions, transaction;
            return __generator(this, function (_f) {
                switch (_f.label) {
                    case 0:
                    ...
                    case 2:
                        _e = _f.sent(), executeAllActions = _e.executeAllActions, actions = _e.actions;
