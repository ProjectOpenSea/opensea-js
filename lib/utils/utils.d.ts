...
import { AnnotatedFunctionABI, Schema, Network } from "wyvern-schemas/dist/types";
...
export declare const isFeeWrapperFlow: (order: Order, network: Network) => boolean;
export declare const getFeeWrapperAddress: (network: Network) => string;
