...
var isFeeWrapperFlow = function (order, network) {
    var feeWrapperAddress = (0, exports.getFeeWrapperAddress)(network);
    var isCorrectFeeRecipient = order.side === types_2.OrderSide.Sell
        ? order.feeRecipient === feeWrapperAddress
        : true;
    return order.staticTarget === feeWrapperAddress && isCorrectFeeRecipient;
};
exports.isFeeWrapperFlow = isFeeWrapperFlow;
var getFeeWrapperAddress = function (network) {
    return network === types_1.Network.Main
        ? constants_1.FEE_WRAPPER_ADDRESS_MAINNET
        : constants_1.FEE_WRAPPER_ADDRESS_RINKEBY;
};
exports.getFeeWrapperAddress = getFeeWrapperAddress;
