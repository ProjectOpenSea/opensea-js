...
exports.assetFromJSON = function (asset) {
    ...
    return exports.groupAndAggregateOrders(fromJSON, asset);
};
...
exports.assetBundleFromJSON = function (asset_bundle) {
    var fromJSON = {
        ...
        sellOrders: null,
        buyOrders: null,
        orders: asset_bundle.orders ? asset_bundle.orders.map(exports.orderFromJSON) : null,
    };
    return exports.groupAndAggregateOrders(fromJSON, asset_bundle);
};
exports.groupAndAggregateOrders = function (assetOrBundleFromJson, asset_or_bundle) {
    assetOrBundleFromJson.sellOrders = asset_or_bundle.sell_orders
        ? asset_or_bundle.sell_orders.map(exports.orderFromJSON)
        : null;
    assetOrBundleFromJson.buyOrders = asset_or_bundle.buy_orders
        ? asset_or_bundle.buy_orders.map(exports.orderFromJSON)
        : null;
    ...
    if (assetOrBundleFromJson.orders && !assetOrBundleFromJson.sellOrders) {
        assetOrBundleFromJson.sellOrders = assetOrBundleFromJson.orders.filter(function (o) { return o.side == types_2.OrderSide.Sell; });
    }
    if (assetOrBundleFromJson.orders && !assetOrBundleFromJson.buyOrders) {
        assetOrBundleFromJson.buyOrders = assetOrBundleFromJson.orders.filter(function (o) { return o.side == types_2.OrderSide.Buy; });
    }
