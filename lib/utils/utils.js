...
function getOrderHash(order) {
    ...
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    return getOrderHashHex(orderWithStringTypes);
}
...
function getOrderHashHex(order) {
    var orderParts = [
        ...
        {
            value: safe_buffer_1.Buffer.from(order.calldata.slice(2), "hex"),
            type: types_1.SolidityTypes.Bytes,
        },
        {
            value: safe_buffer_1.Buffer.from(order.replacementPattern.slice(2), "hex"),
            type: types_1.SolidityTypes.Bytes,
        },
        { value: order.staticTarget, type: types_1.SolidityTypes.Address },
        {
            value: safe_buffer_1.Buffer.from(order.staticExtradata.slice(2), "hex"),
            type: types_1.SolidityTypes.Bytes,
        },
        { value: order.paymentToken, type: types_1.SolidityTypes.Address },
        { value: bigNumberToBN(order.basePrice), type: types_1.SolidityTypes.Uint256 },
        { value: bigNumberToBN(order.extra), type: types_1.SolidityTypes.Uint256 },
        { value: bigNumberToBN(order.listingTime), type: types_1.SolidityTypes.Uint256 },
        { value: bigNumberToBN(order.expirationTime), type: types_1.SolidityTypes.Uint256 },
    ...
    var hash = safe_buffer_1.Buffer.from(ethABI.soliditySHA3(types, values));
