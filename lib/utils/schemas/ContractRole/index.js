...
exports.ContractRoleSchema = {
    ...
    formatter: function (asset) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, {
                    thumbnail: "https://i.redditmedia.com/NaFzmSbDX2T2RALMxy2tmGJN_gPVNH9lJggCKUDDqcc.jpg?w=320&s=3913239508209aaf6ba1188fe3d3b5fc",
                    title: "Smart Contract Role: ".concat(asset.roleGetter, " for ").concat(asset.name),
                    description: asset.description ||
                        "".concat(asset.roleGetter, " for smart contract at ").concat(asset.address),
    ...
    hash: function (a) { return a.address; },
};
