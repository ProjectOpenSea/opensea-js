...
exports.ERC721Schema = {
    ...
    functions: {
        ...
        checkAndTransfer: function (asset, validatorAddress, merkle) { return ({
            type: types_1.AbiType.Function,
...
exports.ERC721v3Schema = __assign(__assign({}, exports.ERC721Schema), { version: 3, name: "ERC721v3", description: "Items conforming to the ERC721 v3 spec, using safeTransferFrom.", functions: __assign(__assign({}, exports.ERC721Schema.functions), { transfer: function (asset) { return ({
            type: types_1.AbiType.Function,
