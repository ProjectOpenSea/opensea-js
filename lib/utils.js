                ...
                case 7:
                    if (owner !== undefined) {
                        if (proxy && owner.toLowerCase() === proxy.toLowerCase()) {
                            ...
                            return [2 /*return*/, onUnknownOwner(owner)];
                        }
                    }
...
function getWyvernBundle(schema, assets) {
    var wyAssets = assets.map(function (asset) { return getWyvernAsset(schema, asset.tokenId, asset.tokenAddress); });
