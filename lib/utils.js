...
function getWyvernAsset(schema, asset, quantity) {
    ...
    if ('identifier' in asset) {
        return getWyvernFTAsset(schema, asset.tokenAddress, asset.identifier, quantity, asset.tokenId);
    }
    else {
 ...
 */
function getWyvernFTAsset(schema, address, identifier, quantity, id) {
