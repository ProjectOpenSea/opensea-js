 ...
 */
function getWyvernERC721Asset(schema, tokenId, tokenAddress) {
    return schema.assetFromFields({
        'ID': tokenId.toString(),
        'Address': tokenAddress.toLowerCase(),
    });
}
exports.getWyvernERC721Asset = getWyvernERC721Asset;
/**
...
function getWyvernBundle(schema, assets) {
    var wyAssets = assets.map(function (asset) { return getWyvernERC721Asset(schema, asset.tokenId, asset.tokenAddress); });
