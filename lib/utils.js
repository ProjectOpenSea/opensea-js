...
function estimateCurrentPrice(order, secondsToBacktrack, shouldRoundUp) {
    ...
    if (order.side == types_2.OrderSide.Sell && order.takerRelayerFee) {
        // Add buyer fee
        exactPrice = exactPrice.times(+order.takerRelayerFee / exports.INVERSE_BASIS_POINT + 1);
    }
