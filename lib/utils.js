...
exports.INFURA_KEY = 'e8695bce67944848aa95459fac052f8e';
...
exports.SELL_ORDER_BATCH_SIZE = 2;
 ...
 */
function sendRawTransaction(web3, _a, awaitConfirmation) {
    var from = _a.from, to = _a.to, data = _a.data, gasPrice = _a.gasPrice, _b = _a.value, value = _b === void 0 ? 0 : _b;
    if (awaitConfirmation === void 0) { awaitConfirmation = false; }
    return __awaiter(this, void 0, void 0, function () {
...
function estimateCurrentPrice(order, secondsToBacktrack, shouldRoundUp) {
    ...
    if (order.saleKind == types_2.SaleKind.FixedPrice) {
        // Do nothing, price is correct
    }
    else if (order.saleKind == types_2.SaleKind.DutchAuction) {
...
function encodeAtomicizedTransfer(schema, assets, from, to, atomicizer) {
    var transactions = assets.map(function (asset) {
        var transfer = schema.functions.transferFrom(asset);
