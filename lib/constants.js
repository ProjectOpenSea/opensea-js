...
exports.MAINNET_PROVIDER_URL = "".concat(let_BASE_MAINNET, "/").concat(let_URL_PATH);
exports.RINKEBY_PROVIDER_URL = "".concat(let_BASE_RINKEBY, "/").concat(let_URL_PATH);
exports.ORDERBOOK_PATH = "/wyvern/v".concat(letERBOOK_VERSION);
exports.API_PATH = "/api/v".concat(letERBOOK_VERSION);
