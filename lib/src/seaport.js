...
var OpenSeaPort = /** @class */ (function () {
    ...
    OpenSeaPort.prototype.transfer = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var schema, nftVersion, wyAsset, isCryptoKitties, isOldNFT, abi, gasPrice, txHash;
            var _this = this;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        schema = this._getSchema(schemaName);
                        nftVersion = asset.version || types_1.TokenStandardVersion.ERC721v3;
                        wyAsset = utils_1.getWyvernAsset(schema, asset, quantity);
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, utils_1.promisifyCall(function (c) { return contract_1[abi_1.name].call([accountAddress].concat(inputValues_1), c); })];
                    case 3:
                        count = _c.sent();
                        if (count === undefined) {
                            console.warn(abi_1, [accountAddress].concat(inputValues_1));
                            return [2 /*return*/, undefined];
                        }
                        if (!(+count < minAmount && proxyAddress)) return [3 /*break*/, 5];
                        return [4 /*yield*/, utils_1.promisifyCall(function (c) { return contract_1[abi_1.name].call([proxyAddress].concat(inputValues_1), c); })];
                    case 4:
                        proxyCount = _c.sent();
                        count = count.add(proxyCount || 0);
                        _c.label = 5;
                    case 5: return [2 /*return*/, +count >= minAmount];
                    case 6:
