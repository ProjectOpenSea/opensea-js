...
var OpenSeaPort = /** @class */ (function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        isOldNFT = isCryptoKitties || [types_1.TokenStandardVersion.ERC721v1, types_1.TokenStandardVersion.ERC721v2].includes(asset.nftVersion);
                        abi = isOldNFT
                ...
                switch (_d.label) {
                    ...
                    case 4:
                        ...
                        return [2 /*return*/, Promise.all(wyAssets.map(function (wyAsset) { return __awaiter(_this, void 0, void 0, function () {
                                var isOwner, wyNFTAsset, wyFTAsset;
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0: return [4 /*yield*/, this._ownsAssetOnChain({
                                                accountAddress: accountAddress,
                                                proxyAddress: proxyAddress,
                                                wyAsset: wyAsset,
    ...
    OpenSeaPort.prototype._ownsAssetOnChain = function (_a, retries) {
        ...
        if (retries === void 0) { retries = 1; }
        return __awaiter(this, void 0, void 0, function () {
            var schema, _b, abi_1, contract_1, inputs_1, count, proxyCount, abi_2, contract_2, inputs_2, owner;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        schema = this._getSchema(schemaName);
                    ...
                    case 2:
                        ...
                        inputs_1 = abi_1.inputs.filter(function (x) { return x.value !== undefined; }).map(function (x) { return x.value; });
                        return [4 /*yield*/, utils_1.promisifyCall(function (c) { return contract_1[abi_1.name].call(inputs_1.concat([accountAddress]), c); })];
                    case 3:
                        count = +((_c.sent()) || 0);
                        if (!(count == 0 && proxyAddress)) return [3 /*break*/, 5];
                        return [4 /*yield*/, utils_1.promisifyCall(function (c) { return contract_1[abi_1.name].call(inputs_1.concat([proxyAddress]), c); })];
                    case 4:
                        proxyCount = +((_c.sent()) || 0);
                        count += proxyCount;
                        _c.label = 5;
                    case 5: 
                    ...
                    case 6:
                        ...
                        if (abi_2.inputs.filter(function (x) { return x.value === undefined; }).length != 0) {
                            console.warn("Undefined ownerOf specification for this asset type");
                            return [2 /*return*/, undefined];
                        }
                        inputs_2 = abi_2.inputs.map(function (i) { return i.value.toString(); });
                        return [4 /*yield*/, utils_1.promisifyCall(function (c) {
                                var _a;
                                return (_a = contract_2[abi_2.name]).call.apply(_a, inputs_2.concat([c]));
                            })];
                    case 7:
                        owner = _c.sent();
                        if (owner && owner != '0x') {
