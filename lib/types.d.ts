...
export declare type WyvernAtomicMatchParametersWithEthers = [string[], EthersBigNumber[], Array<(number | BigNumber)>, string, string, string, string, string, string, Array<(number | BigNumber)>, string[]];
export declare type WyvernFeeWrapperAtomicMatchParameters = [WyvernAtomicMatchParametersWithEthers, string, FeeData];
/**
