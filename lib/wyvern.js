...
exports.orderFromJSONv0 = function (order) {
    var fromJSON = {
        hash: order.hash,
...
exports.assetFromJSON = function (asset) {
    var fromJSON = {
        ...
        orders: asset.orders.map(exports.orderFromJSON)
    };
    return fromJSON;
};
...
exports.orderToJSON = function (order) {
    ...
    var hash = 'hash' in order ? order.hash : wyvern_js_1.WyvernProtocol.getOrderHashHex(asJSON);
    asJSON.hash = hash;
...
function sendRawTransaction(web3, _a) {
    var fromAddress = _a.fromAddress, toAddress = _a.toAddress, data = _a.data, _b = _a.value, value = _b === void 0 ? 0 : _b, _c = _a.awaitConfirmation, awaitConfirmation = _c === void 0 ? false : _c;
    return __awaiter(this, void 0, void 0, function () {
        var txHash;
