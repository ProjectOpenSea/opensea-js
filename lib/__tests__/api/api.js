...
(0, mocha_1.suite)("api", function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    expirationTime = Math.round(Date.now() / 1000 + constants_1.MIN_EXPIRATION_MINUTES * 60);
    ...
    mocha_1.test.skip("API fetches orders for asset owner", function () { return __awaiter(void 0, void 0, void 0, function () {
        var forOwner, owners;
        return __generator(this, function (_a) {
            switch (_a.label) {
    ...
    // Temp skip due to migration
    mocha_1.test.skip("API fetches buy orders for maker", function () { return __awaiter(void 0, void 0, void 0, function () {
        var forMaker;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, constants_2.apiToTest.getOrders({
