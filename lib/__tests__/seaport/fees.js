...
function unitTestFeesBuyOrder(_a) {
    ...
    chai_1.assert.equal(feeRecipient, (0, utils_1.getFeeWrapperAddress)(types_1.Network.Main));
...
function testFeesMakerOrder(order, collection, makerBountyBPS) {
    ...
    if (order.waitingForBestCounterOrder) {
        ...
        chai_1.assert.equal(order.feeRecipient, (0, utils_1.getFeeWrapperAddress)(types_1.Network.Main));
    }
    // Public order
