...
(0, mocha_1.suite)("seaport: orders", function () {
    ...
    (0, mocha_1.test)("Correctly errors for invalid sell order price parameters", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    accountAddress = constants_2.ALEX_ADDRESS;
                    expirationTime = Math.round(Date.now() / 1000 + 900);
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    sellOrder = _a.sent();
                    return [4 /*yield*/, client._makeBuyOrder({
                            asset: { tokenAddress: tokenAddress, tokenId: tokenId, schemaName: types_2.WyvernSchemaName.ERC721 },
                            quantity: 1,
                            accountAddress: accountAddress,
                            paymentTokenAddress: paymentTokenAddress,
                            startAmount: amountInToken,
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    sellOrder = _a.sent();
                    return [4 /*yield*/, client._makeBuyOrder({
                            asset: { tokenAddress: tokenAddress, tokenId: tokenId, schemaName: types_2.WyvernSchemaName.ERC721v3 },
                            quantity: 1,
                            accountAddress: accountAddress,
                            paymentTokenAddress: paymentTokenAddress,
                            startAmount: amountInToken,
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    expirationTime = Math.round(Date.now() / 1000 + 60 * 60 * 24);
                    return [4 /*yield*/, client._makeSellOrder({
                            asset: { tokenAddress: tokenAddress, tokenId: tokenId, schemaName: types_2.WyvernSchemaName.ERC20 },
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    asset = _a.sent();
                    return [4 /*yield*/, client._makeSellOrder({
                            asset: { tokenAddress: tokenAddress, tokenId: tokenId, schemaName: types_2.WyvernSchemaName.ERC1155 },
                            quantity: 1,
                            accountAddress: accountAddress,
                            startAmount: amountInEth,
                            paymentTokenAddress: constants_1.NULL_ADDRESS,
    ...
    mocha_1.test.skip("orderToJSON computes correct current price for Dutch auctions", function () { return __awaiter(void 0, void 0, void 0, function () {
        var orders;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    orders.map(function (order) {
                        ...
                        var multiple = order.side == types_2.OrderSide.Sell
    ...
    mocha_1.test.skip("Matches first buy order in book", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, client.api.getOrder({ side: types_2.OrderSide.Buy })];
                case 1:
                    order = _a.sent();
    ...
    (0, mocha_1.test)("Correct order data on merkle ERC721 listing", function () { return __awaiter(void 0, void 0, void 0, function () {
        var accountAddress, tokenId, tokenAddress, quantity, decimals, order;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    (0, mocha_1.test)("Correct order data on merkle ERC1155 listing", function () { return __awaiter(void 0, void 0, void 0, function () {
        var accountAddress, tokenId, tokenAddress, quantity, decimals, order;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    (0, mocha_1.test)("Correct order data on merkle ERC721 offer", function () { return __awaiter(void 0, void 0, void 0, function () {
        var accountAddress, paymentTokenAddress, amountInToken, tokenId, tokenAddress, order;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    accountAddress = constants_2.ALEX_ADDRESS_2;
    ...
    (0, mocha_1.test)("Correct order data on merkle ERC1155 offer", function () { return __awaiter(void 0, void 0, void 0, function () {
        var accountAddress, paymentTokenAddress, amountInToken, tokenId, tokenAddress, order;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    (0, mocha_1.test)("Verify no merkle data on ERC721 english auction listing and bids", function () { return __awaiter(void 0, void 0, void 0, function () {
        var accountAddress, takerAddress, paymentTokenAddress, amountInToken, expirationTime, extraBountyBasisPoints, tokenId, tokenAddress, sellOrder, buyOrder;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    accountAddress = constants_2.ALEX_ADDRESS_2;
    ...
    (0, mocha_1.suite)("Expiration times", function () {
        (0, mocha_1.test)("it fails when expiration time is 0", function () { return __awaiter(void 0, void 0, void 0, function () {
            var accountAddress, paymentTokenAddress, tokenId, tokenAddress, error_11, error_12;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        accountAddress = constants_2.ALEX_ADDRESS;
                    ...
                    case 3:
                        error_11 = _a.sent();
                        chai_1.assert.include(error_11.message, "Expiration time cannot be 0");
                        return [3 /*break*/, 4];
                    case 4:
                        _a.trys.push([4, 6, , 7]);
                        return [4 /*yield*/, client._makeBuyOrder({
                    ...
                    case 6:
                        error_12 = _a.sent();
                        chai_1.assert.include(error_12.message, "Expiration time cannot be 0");
                        return [3 /*break*/, 7];
                    case 7: return [2 /*return*/];
                }
            });
        ...
        (0, mocha_1.test)("it fails when expiration time exceeds six months", function () { return __awaiter(void 0, void 0, void 0, function () {
            var accountAddress, paymentTokenAddress, tokenId, tokenAddress, expirationDate, expirationTime, error_13, error_14;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        accountAddress = constants_2.ALEX_ADDRESS;
                    ...
                    case 3:
                        error_13 = _a.sent();
                        chai_1.assert.include(error_13.message, "Expiration time must not exceed six months from now");
                        return [3 /*break*/, 4];
                    case 4:
                        _a.trys.push([4, 6, , 7]);
                        return [4 /*yield*/, client._makeBuyOrder({
                    ...
                    case 6:
                        error_14 = _a.sent();
                        chai_1.assert.include(error_14.message, "Expiration time must not exceed six months from now");
                        return [3 /*break*/, 7];
                    case 7: return [2 /*return*/];
                }
            });
        ...
        (0, mocha_1.test)("it handles expiration time duration correctly", function () { return __awaiter(void 0, void 0, void 0, function () {
            var accountAddress, paymentTokenAddress, tokenId, tokenAddress, listingTime, expirationTime, error_15, error_16, twentyMinuteExpirationTime, sellOrder, buyOrder;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        accountAddress = constants_2.ALEX_ADDRESS;
                    ...
                    case 3:
                        error_15 = _a.sent();
                        chai_1.assert.include(error_15.message, "Expiration time must be at least 15 minutes from the listing date");
                        return [3 /*break*/, 4];
                    case 4:
                        _a.trys.push([4, 6, , 7]);
                        return [4 /*yield*/, client._makeBuyOrder({
                    ...
                    case 6:
                        error_16 = _a.sent();
                        chai_1.assert.include(error_16.message, "Expiration time must be at least 15 minutes from the listing date");
                        return [3 /*break*/, 7];
                    case 7:
...
function testMatchingOrder(order, accountAddress, testAtomicMatch, referrerAddress) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    recipientAddress = order.side === types_2.OrderSide.Sell ? constants_2.ALEX_ADDRESS_2 : accountAddress;
...
function testMatchingNewOrder(order, accountAddress, counterOrderListingTime) {
    return __awaiter(this, void 0, void 0, function () {
        var matchingOrder, v, r, s, buy, sell, isValid;
        var _this = this;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
