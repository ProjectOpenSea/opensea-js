...
import { ENJIN_ADDRESS, INVERSE_BASIS_POINT, MAINNET_PROVIDER_URL, NULL_ADDRESS, RINKEBY_PROVIDER_URL, } from "../../constants";
import { OpenSeaPort } from "../../index";
import { Network, OrderSide, SaleKind, WyvernSchemaName, } from "../../types";
import { assignOrdersToSides, estimateCurrentPrice, getOrderHash, makeBigNumber, orderFromJSON, getFeeWrapperAddress, } from "../../utils/utils";
...
suite("seaport: orders", function () {
    ...
    ordersJSON.map(function (orderJSON, index) {
        test("Order #" + index + " has correct types", function () {
    ...
    ordersJSON.map(function (orderJSON, index) {
        test("Order #" + index + " has correct hash", function () {
            var order = orderFromJSON(orderJSON);
            assert.equal(order.hash, getOrderHash(order));
        });
    });
    test("Correctly sets decimals on fungible order", function () { return __awaiter(void 0, void 0, void 0, function () {
        var accountAddress, tokenId, tokenAddress, quantity, decimals, order;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    accountAddress = ALEX_ADDRESS;
                    tokenId = DISSOLUTION_TOKEN_ID.toString();
    ...
    test("Correctly errors for invalid sell order price parameters", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    error_1 = _a.sent();
                    assert.include(error_1.message, "English auctions must have an expiration time");
                    return [3 /*break*/, 4];
                case 4:
                    _a.trys.push([4, 6, , 7]);
                    return [4 /*yield*/, client._makeSellOrder({
                ...
                case 6:
                    error_2 = _a.sent();
                    assert.include(error_2.message, "English auctions must use wrapped ETH");
                    return [3 /*break*/, 7];
                case 7:
                    _a.trys.push([7, 9, , 10]);
                    return [4 /*yield*/, client._makeSellOrder({
                ...
                case 9:
                    error_3 = _a.sent();
                    assert.include(error_3.message, "End price must be less than or equal to the start price");
                    return [3 /*break*/, 10];
                case 10:
                ...
                case 12:
                    error_4 = _a.sent();
                    assert.include(error_4.message, "Expiration time must be set if order will change in price");
                    return [3 /*break*/, 13];
                case 13:
                ...
                case 15:
                    error_5 = _a.sent();
                    assert.include(error_5.message, "Listing time cannot be in the past");
                    return [3 /*break*/, 16];
                case 16:
                ...
                case 18:
                    error_6 = _a.sent();
                    assert.include(error_6.message, "Cannot schedule an English auction for the future");
                    return [3 /*break*/, 19];
                case 19:
                ...
                case 21:
                    error_7 = _a.sent();
                    assert.include(error_7.message, "Reserve prices may only be set on English auctions");
                    return [3 /*break*/, 22];
                case 22:
                ...
                case 24:
                    error_8 = _a.sent();
                    assert.include(error_8.message, "Reserve price must be greater than or equal to the start amount");
                    return [3 /*break*/, 25];
                case 25: return [2 /*return*/];
            }
        });
    }); });
    test("Correctly errors for invalid buy order price parameters", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    error_9 = _a.sent();
                    assert.include(error_9.message, "Offers must use wrapped ETH or an ERC-20 token");
                    return [3 /*break*/, 4];
                case 4: return [2 /*return*/];
            }
        });
    }); });
    test("Cannot yet match a new English auction sell order, bountied", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 6:
                    error_10 = _a.sent();
                    assert.include(error_10.message, "Buy-side order is set in the future or expired");
                    return [3 /*break*/, 7];
                case 7: return [2 /*return*/];
            }
        });
    }); });
    test.skip("Can match a finished English auction sell order", function () { return __awaiter(void 0, void 0, void 0, function () {
        var makerAddress, takerAddress, matcherAddress, now, paymentTokenAddress, orders, buy, sell, sellPrice, buyPrice, gas;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    makerAddress = ALEX_ADDRESS_2;
                    takerAddress = ALEX_ADDRESS;
                    matcherAddress = DEVIN_ADDRESS;
                ...
                case 1:
                    ...
                    sell = orderFromJSON(englishSellOrderJSON);
    ...
    test("Ensures buy order compatibility with an English sell order", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    sellOrder = _a.sent();
                    return [4 /*yield*/, client._makeBuyOrder({
                            asset: { tokenAddress: tokenAddress, tokenId: tokenId, schemaName: WyvernSchemaName.ERC721 },
                            quantity: 1,
                            accountAddress: accountAddress,
                            paymentTokenAddress: paymentTokenAddress,
                            startAmount: amountInToken,
    ...
    test("Ensures ERC721v3 buy order compatibility with an English sell order", function () { return __awaiter(void 0, void 0, void 0, function () {
        var accountAddress, takerAddress, paymentTokenAddress, amountInToken, expirationTime, extraBountyBasisPoints, tokenId, tokenAddress, asset, sellOrder, buyOrder;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 2:
                    sellOrder = _a.sent();
                    return [4 /*yield*/, client._makeBuyOrder({
                            asset: { tokenAddress: tokenAddress, tokenId: tokenId, schemaName: WyvernSchemaName.ERC721v3 },
                            quantity: 1,
                            accountAddress: accountAddress,
                            paymentTokenAddress: paymentTokenAddress,
                            startAmount: amountInToken,
    ...
    test("Ensures buy order compatibility with an ERC721v3 English sell order", function () { return __awaiter(void 0, void 0, void 0, function () {
        var accountAddress, takerAddress, paymentTokenAddress, amountInToken, expirationTime, extraBountyBasisPoints, tokenId, tokenAddress, asset, sellOrder, buyOrder;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    test.skip("Creates ENS name buy order", function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    test("Matches a private sell order, doesn't for wrong taker", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 5:
                    _a.trys.push([5, 7, , 8]);
                    return [4 /*yield*/, testMatchingNewOrder(order, DEVIN_ADDRESS)];
                case 6:
                    _a.sent();
                    return [3 /*break*/, 8];
                case 7:
    ...
    test("Matches a new dutch sell order of a small amount of ERC-20 item (DAI) for ETH", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    expirationTime = Math.round(Date.now() / 1000 + 60 * 60 * 24);
                    return [4 /*yield*/, client._makeSellOrder({
                            asset: { tokenAddress: tokenAddress, tokenId: tokenId, schemaName: WyvernSchemaName.ERC20 },
    ...
    test("Matches a new sell order of an 1155 item for ETH", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    asset = _a.sent();
                    return [4 /*yield*/, client._makeSellOrder({
                            asset: { tokenAddress: tokenAddress, tokenId: tokenId, schemaName: WyvernSchemaName.ERC1155 },
                            quantity: 1,
                            accountAddress: accountAddress,
                            startAmount: amountInEth,
                            paymentTokenAddress: NULL_ADDRESS,
    ...
    test("Matches a buy order of an 1155 item for W-ETH", function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    test("Matches a new bountied sell order for an ERC-20 token (MANA)", function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    test("Matches a buy order with an ERC-20 token (DAI)", function () { return __awaiter(void 0, void 0, void 0, function () {
        var accountAddress, takerAddress, paymentToken, amountInToken, tokenId, tokenAddress, asset, order;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    test("Serializes payment token and matches most recent ERC-20 sell order", function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    test("Bulk transfer", function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    test("orderToJSON computes correct current price for Dutch auctions", function () { return __awaiter(void 0, void 0, void 0, function () {
        var orders;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    orders.map(function (order) {
                        ...
                        var multiple = order.side == OrderSide.Sell
    ...
    test.skip("orderToJSON current price includes buyer fee", function () { return __awaiter(void 0, void 0, void 0, function () {
        var orders;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, client.api.getOrders({
                ...
                case 1:
                    ...
                    orders.map(function (order) {
                        ...
                        var multiple = +buyerFeeBPS / INVERSE_BASIS_POINT + 1;
                        assert.equal(order.basePrice.times(multiple).toNumber(), estimateCurrentPrice(order).toNumber());
                    });
                    return [2 /*return*/];
            }
        });
    }); });
    test("orderToJSON current price does not include buyer fee for English auctions", function () { return __awaiter(void 0, void 0, void 0, function () {
        var orders;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, client.api.getOrders({
                ...
                case 1:
                    ...
                    orders.map(function (order) {
                        ...
                        assert.equal(order.basePrice.toNumber(), estimateCurrentPrice(order).toNumber());
                    });
                    return [2 /*return*/];
            }
        });
    }); });
    test.skip("Matches first buy order in book", function () { return __awaiter(void 0, void 0, void 0, function () {
        var order, assetOrBundle, takerAddress;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, client.api.getOrder({ side: OrderSide.Buy })];
                case 1:
                    order = _a.sent();
    ...
    test.skip("Matches a buy order and estimates gas on fulfillment", function () { return __awaiter(void 0, void 0, void 0, function () {
        var takerAddress, order;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
...
function testMatchingOrder(order, accountAddress, testAtomicMatch, referrerAddress) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    recipientAddress = order.side === OrderSide.Sell ? ALEX_ADDRESS_2 : accountAddress;
                    ...
                    _a = assignOrdersToSides(order, matchingOrder), buy = _a.buy, sell = _a.sell;
...
export function testMatchingNewOrder(unhashedOrder, accountAddress, counterOrderListingTime) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    order = __assign(__assign({}, unhashedOrder), { hash: getOrderHash(unhashedOrder) });
                    matchingOrder = client._makeMatchingOrder({
                        order: order,
                        accountAddress: accountAddress,
                    ...
                    if (order.waitingForBestCounterOrder) {
                        assert.equal(matchingOrder.feeRecipient, getFeeWrapperAddress(Network.Main));
                    }
                    else {
                                ...
                                return __generator(this, function (_b) {
                                    switch (_b.label) {
                                        ...
                                        case 1:
                                            ...
                                            assert.isTrue(isTransferrable, "Not transferrable: ".concat(asset.tokenAddress, " # ").concat(asset.tokenId, " schema ").concat(asset.schemaName, " quantity ").concat(quantity, " from ").concat(fromAddress, " to ").concat(toAddress, " using proxy: ").concat(useProxy));
                                            return [2 /*return*/];
                                    }
                                });
                            });
...
function getAssetsAndQuantities(order) {
    ...
    return wyAssets.map(function (wyAsset, i) {
        ...
        if ("quantity" in wyAsset) {
            return { asset: asset, quantity: new BigNumber(wyAsset.quantity) };
        }
        else {
            return { asset: asset, quantity: new BigNumber(1) };
        }
    });
}
