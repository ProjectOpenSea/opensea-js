...
mocha_typescript_1.suite('seaport', function () {
    ...
    mocha_typescript_1.test("On-chain ownership throws for invalid assets", function () { return __awaiter(_this, void 0, void 0, function () {
        var accountAddress, schemaName, wyAssetRinkeby, isOwner, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    wyAssetRinkeby = {
                        id: constants_1.CK_RINKEBY_TOKEN_ID.toString(),
                        address: constants_1.CK_RINKEBY_ADDRESS
                    };
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, client._ownsAssetOnChain({ accountAddress: accountAddress, wyAsset: wyAssetRinkeby, schemaName: schemaName })];
                case 2:
                    isOwner = _a.sent();
                    chai_1.assert.fail();
                    return [3 /*break*/, 4];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, client._ownsAssetOnChain({ accountAddress: constants_1.ALEX_ADDRESS_2, wyAsset: wyAsset, schemaName: schemaName })];
                case 2:
                    isOwner2 = _a.sent();
    ...
    mocha_typescript_1.test("On-chain ownership correctly pulled for ERC20s", function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    wyAsset = {
                        address: utils_1.ENJIN_COIN_ADDRESS,
                ...
                case 1:
                    isOwner = _a.sent();
                    chai_1.assert.isTrue(isOwner);
                    return [4 /*yield*/, client._ownsAssetOnChain({ accountAddress: accountAddress, wyAsset: __assign({}, wyAsset, { quantity: utils_1.MAX_UINT_256 }), schemaName: schemaName })];
                case 2:
                    isOwner2 = _a.sent();
                    chai_1.assert.isFalse(isOwner2);
                    return [4 /*yield*/, client._ownsAssetOnChain({ accountAddress: constants_1.RANDOM_ADDRESS, wyAsset: wyAsset, schemaName: schemaName })];
                case 3:
                    isOwner3 = _a.sent();
    ...
    mocha_typescript_1.test.only("On-chain ownership correctly pulled for ERC1155s", function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    wyAssetNFT = {
                        id: constants_1.CATS_IN_MECHS_ID,
                        address: utils_1.ENJIN_ADDRESS
                    };
                    return [4 /*yield*/, client._ownsAssetOnChain({ accountAddress: accountAddress, wyAsset: wyAssetNFT, schemaName: schemaName })];
                case 1:
                    isOwner = _a.sent();
                    chai_1.assert.isTrue(isOwner);
                    return [4 /*yield*/, client._ownsAssetOnChain({ accountAddress: constants_1.RANDOM_ADDRESS, wyAsset: wyAssetNFT, schemaName: schemaName })];
                case 2:
                    isOwner2 = _a.sent();
                    chai_1.assert.isFalse(isOwner2);
                    wyAssetFT = {
                ...
                case 3:
                    ...
                    return [4 /*yield*/, client._ownsAssetOnChain({ accountAddress: accountAddress, wyAsset: __assign({}, wyAssetFT, { quantity: utils_1.MAX_UINT_256 }), schemaName: schemaName })];
                case 4:
                    isOwner5 = _a.sent();
                    chai_1.assert.isFalse(isOwner5);
                    return [4 /*yield*/, client._ownsAssetOnChain({ accountAddress: constants_1.RANDOM_ADDRESS, wyAsset: wyAssetFT, schemaName: schemaName })];
                case 5:
                    isOwner4 = _a.sent();
    ...
    mocha_typescript_1.test("Correctly errors for invalid price parameters", function () { return __awaiter(_this, void 0, void 0, function () {
        var accountAddress, expirationTime, paymentTokenAddress, tokenId, tokenAddress, error_2, error_3, error_4, error_5;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    accountAddress = constants_1.ALEX_ADDRESS;
                ...
                case 3:
                    error_2 = _a.sent();
                    chai_1.assert.include(error_2.message, 'English auctions must have an expiration time');
                    return [3 /*break*/, 4];
                case 4:
                    _a.trys.push([4, 6, , 7]);
                    return [4 /*yield*/, client._makeSellOrder({
                ...
                case 6:
                    error_3 = _a.sent();
                    chai_1.assert.include(error_3.message, 'English auctions must use wrapped ETH');
                    return [3 /*break*/, 7];
                case 7:
                    _a.trys.push([7, 9, , 10]);
                    return [4 /*yield*/, client._makeSellOrder({
                ...
                case 9:
                    error_4 = _a.sent();
                    chai_1.assert.include(error_4.message, 'End price must be less than or equal to the start price');
                    return [3 /*break*/, 10];
                case 10:
                ...
                case 12:
                    error_5 = _a.sent();
                    chai_1.assert.include(error_5.message, 'Expiration time must be set if order will change in price');
                    return [3 /*break*/, 13];
    ...
    mocha_typescript_1.test('Cannot yet match a new English auction sell order, bountied', function () { return __awaiter(_this, void 0, void 0, function () {
        var accountAddress, takerAddress, amountInToken, paymentTokenAddress, expirationTime, bountyPercent, tokenId, tokenAddress, asset, order, error_6;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    accountAddress = constants_1.ALEX_ADDRESS;
                ...
                case 7:
                    error_6 = _a.sent();
                    chai_1.assert.include(error_6.message, "Unable to match offer with auction.");
                    return [3 /*break*/, 8];
    ...
    mocha_typescript_1.test("Errors for computing fees correctly", function () { return __awaiter(_this, void 0, void 0, function () {
        var tokenId, tokenAddress, asset, error_7;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    tokenId = constants_1.MYTHEREUM_TOKEN_ID.toString();
                ...
                case 4:
                    error_7 = _a.sent();
                    if (!error_7.message.includes('bounty exceeds the maximum') ||
                        !error_7.message.includes('OpenSea will add')) {
                        chai_1.assert.fail(error_7.message);
                    }
                    return [3 /*break*/, 5];
