...
mocha_typescript_1.suite('seaport', function () {
    ...
    mocha_typescript_1.test("On-chain ownership undefined for non-existent assets", function () { return __awaiter(_this, void 0, void 0, function () {
        var accountAddress, schemaName, wyAssetRinkeby, isOwner;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 1:
                    isOwner = _a.sent();
                    chai_1.assert.isUndefined(isOwner);
                    return [2 /*return*/];
            }
        });
    }); });
    ...
    mocha_typescript_1.test.only("On-chain ownership correctly pulled for ERC1155s", function () { return __awaiter(_this, void 0, void 0, function () {
        var accountAddress, schemaName, id, wyAssetNFT, isOwner;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    accountAddress = constants_1.ALEX_ADDRESS;
