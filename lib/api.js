    ...
    function OpenSeaAPI(_a) {
        ...
        switch (networkName) {
            case types_1.Network.Rinkeby:
                this.apiBaseUrl = exports.API_BASE_RINKEBY;
                this.hostUrl = exports.SITE_HOST_RINKEBY;
                break;
            case types_1.Network.Main:
            default:
                this.apiBaseUrl = exports.API_BASE_MAINNET;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        json = _a.sent();
                        return [2 /*return*/, json ? wyvern_1.assetFromJSON(json, this.hostUrl) : null];
                }
            });
        });
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        json = _a.sent();
                        return [2 /*return*/, {
                                assets: json.assets.map(function (j) { return wyvern_1.assetFromJSON(j, _this.hostUrl); }),
