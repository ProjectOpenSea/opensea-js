    ...
    OpenSeaAPI.prototype.postOrder = function (order) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.post(this.orderbookPath + "/orders/post", order)];
    ...
    OpenSeaAPI.prototype._fetch = function (apiPath, opts) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                apiKey = this.apiKey;
                return [2 /*return*/, isomorphic_unfetch_1.default(apiBase + apiPath, __assign({}, opts, { headers: __assign({}, (apiKey ? { 'X-API-KEY': apiKey } : {}), (opts.headers || {})) })).then(throwOnUnauth)];
            });
        });
    };
    return OpenSeaAPI;
