...
exports.orderToJSON = wyvern_1.orderToJSON;
exports.orderFromJSON = wyvern_1.orderFromJSON;
...
var OpenSea = /** @class */ (function () {
    ...
    OpenSea.prototype.addListener = function (event, listener, once) {
    ...
    OpenSea.prototype.removeAllListeners = function (event) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                ...
                return [2 /*return*/, wyvern_1.sendRawTransaction(this.web3, {
                        ...
                        toAddress: token.address,
                        value: 0,
                        data: WyvernSchemas.encodeCall(contracts_1.getMethod(contracts_1.CanonicalWETH, 'withdraw'), [baseAmount.toString()]),
                        awaitConfirmation: awaitConfirmation,
                    })];
            });
        });
    ...
    OpenSea.prototype.approveNonFungibleToken = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var tokenContract, erc721, isApprovedCheckData, isApprovedForAllCallHash, isApprovedForAll, transactionHash, error_3, approvedAddr, transactionHash, error_4;
            var _this = this;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                    ...
                    case 9: return [4 /*yield*/, wyvern_1.promisify(function (c) { return erc721.getApproved.call(tokenId, c); })];
                    case 10:
    ...
    OpenSea.prototype._signOrder = function (order) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    OpenSea.prototype._dispatch = function (event, data) {
        if (data === void 0) { data = {}; }
