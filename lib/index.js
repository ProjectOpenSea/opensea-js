...
var OpenSea = /** @class */ (function () {
    function OpenSea(web3Provider, _a) {
        var _b = _a.networkName, networkName = _b === void 0 ? "main" : _b, _c = _a.gasPrice, gasPrice = _c === void 0 ? 100000 : _c;
        // Web3 Config
        this.web3Provider = web3Provider;
        this.web3 = new Web3(this.web3Provider);
        this.networkName = networkName;
        // WyvernJS config
        this.wyvernProtocol = new lib_1.WyvernProtocol(this.web3Provider, {
                ...
                switch (_d.label) {
                    case 0:
                        ...
                        order = {
                            ...
                            feeMethod: wyvern_1.feeMethod.PROTOCOL_FEE,
                            feeRecipient: wyvern_1.feeRecipient,
                            side: wyvern_1.orderSide.BUY,
                            saleKind: wyvern_1.saleKind.FIXED_PRICE,
                            target: target,
                            howToCall: wyvern_1.howToCall.CALL,
                            calldata: calldata,
                    ...
                    case 5:
                        ...
                        return [4 /*yield*/, this._validateAndPostOrder(orderJSON)];
                ...
                switch (_d.label) {
                    case 0:
                        ...
                        orderSaleKind = endAmountInEth != null && endAmountInEth != startAmountInEth
                            ? wyvern_1.saleKind.DUTCH_AUCTION
                            : wyvern_1.saleKind.FIXED_PRICE;
                        order = {
                            exchange: lib_1.WyvernProtocol.getExchangeContractAddress(this.networkName),
                            maker: accountAddress,
                            taker: lib_1.WyvernProtocol.NULL_ADDRESS,
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        buy = order.side === wyvern_1.orderSide.BUY ? order : orderToMatch;
                        sell = order.side === wyvern_1.orderSide.BUY ? orderToMatch : order;
    ...
    OpenSea.prototype._atomicMatch = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var _b, protocolInstance, value, orderLookupHash, buyValid, sellValid, currentPrice, ordersCanMatch, orderCalldataCanMatch, args, txHash, error_5;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        protocolInstance = this.wyvernProtocol;
    ...
    OpenSea.prototype._makeMatchingOrder = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                ...
                _b = order.side === wyvern_1.orderSide.BUY
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, wyvern_1.findAsset(accountAddress, proxyAddress, wyAsset, schema)];
                    case 2:
                        where = _c.sent();
                        if (where === 'other') {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, wyvern_1.personalSignAsync(this.web3, { message: message, signerAddress: signerAddress })];
    ...
    OpenSea.prototype._getWyvernAsset = function (schema, _a) {
