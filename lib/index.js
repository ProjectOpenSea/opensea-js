        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 8: return [4 /*yield*/, wyvern_1.promisify(function (c) { return erc721.getApproved.call(tokenId, c); })];
                    case 9:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        txHash = _a.sent();
                        // TODO dispatch(ExchangeActions._setTransactionHash(txHash))
                        return [4 /*yield*/, wyvern_1.confirmTransaction(this.web3, txHash)];
                    case 2:
                        // TODO dispatch(ExchangeActions._setTransactionHash(txHash))
                        _a.sent();
                        return [4 /*yield*/, this._getProxy(accountAddress)];
