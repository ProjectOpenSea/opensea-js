...
export var MAX_ERROR_LENGTH = 120;
/**
 ...
 */
export function requireOrdersCanMatch(client, _a) {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    if (!((sell.feeRecipient == NULL_ADDRESS && buy.feeRecipient != NULL_ADDRESS) ||
 ...
 * @param sell Sell Order for debugging
 */
export function requireOrderCalldataCanMatch(client, _a) {
