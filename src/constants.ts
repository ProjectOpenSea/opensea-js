...
export const MAINNET_PROVIDER_URL = `${let_BASE_MAINNET}/${let_URL_PATH}`
export const RINKEBY_PROVIDER_URL = `${let_BASE_RINKEBY}/${let_URL_PATH}`
export const ORDERBOOK_PATH = `/wyvern/v${letERBOOK_VERSION}`
export const API_PATH = `/api/v${letERBOOK_VERSION}`
