...
export const CHEEZE_WIZARDS_ADDRESS = WyvernProtocol.NULL_ADDRESS // TODO: Dapper has not yet deployed this contract, pre-sale contract is at 0x2F4Bdafb22bd92AA7b7552d270376dE8eDccbc1E
export const CHEEZE_WIZARDS_RINKEBY_ADDRESS = '0xb4aCd2c618EB426a8E195cCA2194c0903372AC0d'
export const CHEEZE_WIZARDS_BASIC_TOURNAMENT_ADDRESS = WyvernProtocol.NULL_ADDRESS // TODO: Dapper has not yet deployed this contract
export const CHEEZE_WIZARDS_BASIC_TOURNAMENT_RINKEBY_ADDRESS = '0x108FC97479Ec5E0ab8e68584b3Ea9518BE78BeB4'
export const DECENTRALAND_ESTATE_ADDRESS = '0x959e104e1a4db6317fa58f8295f586e1a978c297'
export const DECENTRALAND_ESTATE_RINKEBY_ADDRESS = WyvernProtocol.NULL_ADDRESS // TODO: Decentraland uses Ropstein, not Rinkeby
export const STATIC_CALL_TX_ORIGIN_ADDRESS = WyvernProtocol.NULL_ADDRESS // TODO: Deploy this address once we know what the OpenSeaAdmin mainnet address is
export const STATIC_CALL_TX_ORIGIN_RINKEBY_ADDRESS = WyvernProtocol.NULL_ADDRESS // TODO: Deploy this address once we know what the OpenSeaAdmin rinkeby address is
export const STATIC_CALL_CHEEZE_WIZARDS_ADDRESS = WyvernProtocol.NULL_ADDRESS // TODO:  Deploy this address once we know what the CheezeWizardsBasicTournament mainnet address is
export const STATIC_CALL_CHEEZE_WIZARDS_RINKEBY_ADDRESS = WyvernProtocol.NULL_ADDRESS // TODO: Deploy this address
export const STATIC_CALL_DECENTRALAND_ESTATES_ADDRESS = WyvernProtocol.NULL_ADDRESS // TODO: Deploy this address
export const STATIC_CALL_DECENTRALAND_ESTATES_RINKEBY_ADDRESS = WyvernProtocol.NULL_ADDRESS // TODO: Deploy this address once we know what the DecentralandEstaters rinkeby address is
